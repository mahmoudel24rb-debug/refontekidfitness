...
// Styles exacts : importer "framer-testimonials.css" une seule fois (layout global).
import './framer-testimonials.css';

export default function TestimonialsPage() {
  return (
    <>
      <div id={"main"}>
        <div className={"framer-U5XZr framer-47Dft framer-UiBmF framer-TCv20 framer-11m9phg"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-ew90ih-container"}>
            <div className={"ssr-variant hidden-1n9l4rf hidden-zmrcco hidden-9b123j"}>
            ...
            <div className={"ssr-variant hidden-11m9phg hidden-9b123j"}>
            ...
            <div className={"ssr-variant hidden-11m9phg hidden-1n9l4rf hidden-zmrcco"}>
          ...
          <div className={"framer-4pjto3"} data-framer-name={"Header"} name={"Header"}>
            <div className={"framer-avz27t"} style={{ transform: "none" }}>
              <h2 className={"framer-text framer-styles-preset-h971pb"} data-styles-preset={"CEhR1NBj_"} style={{ "--framer-text-alignment": "center" }}>
                Avis
              </h2>
            </div>
            <div data-framer-name={"red star"} name={"red star"} className={"framer-ptnkhe"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Star "} name={"Star "} className={"framer-bgnnfx"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Blue "} name={"Blue "} className={"framer-1z0h6xo"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Green"} name={"Green"} className={"framer-199r4rb"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
          ...
          <div className={"framer-1rg2jmr"} data-framer-name={"Testimonials"} name={"Testimonials"}>
            <div className={"framer-1ec0d6e"} data-framer-name={"Title"} name={"Title"}>
              <div data-framer-name={"Star"} name={"Star"} className={"framer-13dpy"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
                <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div className={"framer-3nofhx"}>
              <div className={"framer-t1cn5b"}>
                <div className={"ssr-variant hidden-1n9l4rf"}>
                  <div className={"framer-1mkp99-container"}>
                    <div className={"framer-GOmex framer-Ba2hu framer-5BS8D framer-WGJ4M framer-47Dft framer-U5AuS framer-TCv20 framer-JIYi9 framer-OdaN4 framer-1rg7xd9 framer-v-1rg7xd9"} data-border={"true"} data-framer-name={"Desktop"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                      <div className={"framer-9jm81x"} data-framer-name={"Content Wrapper"}>
                        <div className={"framer-1yfbyme"} data-framer-name={"Profile & Position"}>
                          <div className={"framer-1vshqq3"} data-framer-name={"Profile Pic"} style={{ borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"async"} src={"/assets/framerusercontent.com/images/AeEnjdar40KYcyBzSCA9Qn0Eok.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                            </div>
                          </div>
                      ...
                      <div className={"framer-50ije7"} data-framer-name={"Video"} style={{ borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                        <div className={"framer-960oh7-container"}>
                          <article style={{ position: "relative", width: "100%", height: "100%", borderRadius: "0px", transform: "unset", cursor: "pointer", overflow: "hidden" }} role={"presentation"}>
                            ...
                            <img decoding={"async"} src={"https://i.ytimg.com/vi_webp/xmWEpr7T3_E/sddefault.webp"} style={{ position: "absolute", top: "0", left: "0", height: "100%", width: "100%", objectFit: "cover" }} />
                            <iframe loading={"lazy"} style={{ position: "absolute", top: "0", left: "0", height: "100%", width: "100%", display: "none" }} title={"Youtube Video"} allow={"presentation; fullscreen; accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"} src={"https://www.youtube.com/embed/xmWEpr7T3_E?v=xmWEpr7T3_E&list=PLTDgOUcX23hZDQpj3ZSK-YqHXjoVNqhdO&index=7&iv_load_policy=3&rel=0&modestbranding=1&playsinline=1&autoplay=0"} frameBorder={"0"} />
                ...
                <div className={"ssr-variant hidden-11m9phg hidden-zmrcco hidden-9b123j"}>
                  <div className={"framer-1mkp99-container"}>
                    <div className={"framer-GOmex framer-Ba2hu framer-5BS8D framer-WGJ4M framer-47Dft framer-U5AuS framer-TCv20 framer-JIYi9 framer-OdaN4 framer-1rg7xd9 framer-v-1q87lr1"} data-border={"true"} data-framer-name={"Phone"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                      <div className={"framer-9jm81x"} data-framer-name={"Content Wrapper"}>
                        <div className={"framer-1yfbyme"} data-framer-name={"Profile & Position"}>
                          <div className={"framer-1vshqq3"} data-framer-name={"Profile Pic"} style={{ borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                    ...
                    <div className={"framer-GOmex framer-Ba2hu framer-5BS8D framer-WGJ4M framer-47Dft framer-U5AuS framer-TCv20 framer-JIYi9 framer-OdaN4 framer-1rg7xd9 framer-v-1rg7xd9"} data-border={"true"} data-framer-name={"Desktop"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                      <div className={"framer-9jm81x"} data-framer-name={"Content Wrapper"}>
                        <div className={"framer-1yfbyme"} data-framer-name={"Profile & Position"}>
                          <div className={"framer-1vshqq3"} data-framer-name={"Profile Pic"} style={{ borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"async"} src={"/assets/framerusercontent.com/images/P5SNe5LpYM2CdRrwwN49ZL6E64.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                            </div>
                          </div>
                          <div className={"framer-bggfd5"} data-framer-name={"Name & Program"}>
                            <div className={"framer-17cggy3"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                      ...
                      <div className={"framer-50ije7"} data-framer-name={"Video"} style={{ borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                        <div className={"framer-960oh7-container"}>
                          <article style={{ position: "relative", width: "100%", height: "100%", borderRadius: "0px", transform: "unset", cursor: "pointer", overflow: "hidden" }} role={"presentation"}>
                            <link rel={"preconnect"} href={"https://i.ytimg.com"} />
                            <img decoding={"async"} src={"https://i.ytimg.com/vi_webp/HveG1SXZ7as/sddefault.webp"} style={{ position: "absolute", top: "0", left: "0", height: "100%", width: "100%", objectFit: "cover" }} />
                            <iframe loading={"lazy"} style={{ position: "absolute", top: "0", left: "0", height: "100%", width: "100%", display: "none" }} title={"Youtube Video"} allow={"presentation; fullscreen; accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"} src={"https://www.youtube.com/embed/HveG1SXZ7as?v=HveG1SXZ7as&list=PLTDgOUcX23hZDQpj3ZSK-YqHXjoVNqhdO&index=5&iv_load_policy=3&rel=0&modestbranding=1&playsinline=1&autoplay=0"} frameBorder={"0"} />
                            <button aria-label={"Play"} style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "68px", height: "48px", padding: "0", border: "none", background: "transparent", cursor: "pointer" }}>
                              <svg height={"100%"} version={"1.1"} viewBox={"0 0 68 48"} width={"100%"}>
                                <path d={"M66.52,7.74c-0.78-2.93-2.49-5.41-5.42-6.19C55.79,.13,34,0,34,0S12.21,.13,6.9,1.55 C3.97,2.33,2.27,4.81,1.48,7.74C0.06,13.05,0,24,0,24s0.06,10.95,1.48,16.26c0.78,2.93,2.49,5.41,5.42,6.19 C12.21,47.87,34,48,34,48s21.79-0.13,27.1-1.55c2.93-0.78,4.64-3.26,5.42-6.19C67.94,34.95,68,24,68,24S67.94,13.05,66.52,7.74z"} fill={"#212121"} fillOpacity={"0.8"} style={{ transition: "fill .1s cubic-bezier(0.4, 0, 1, 1), fill-opacity .1s cubic-bezier(0.4, 0, 1, 1)" }} />
                                <path d={"M 45,24 27,14 27,34"} fill={"#fff"} />
                    ...
                    <div className={"framer-GOmex framer-Ba2hu framer-5BS8D framer-WGJ4M framer-47Dft framer-U5AuS framer-TCv20 framer-JIYi9 framer-OdaN4 framer-1rg7xd9 framer-v-1rg7xd9"} data-border={"true"} data-framer-name={"Desktop"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                      <div className={"framer-9jm81x"} data-framer-name={"Content Wrapper"}>
                        <div className={"framer-1yfbyme"} data-framer-name={"Profile & Position"}>
                          <div className={"framer-1vshqq3"} data-framer-name={"Profile Pic"} style={{ borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"async"} src={"/assets/framerusercontent.com/images/yBS1XoCOQf9dxar32wGuJSwaE.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                            </div>
                          </div>
                          <div className={"framer-bggfd5"} data-framer-name={"Name & Program"}>
                            <div className={"framer-17cggy3"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                      ...
                      <div className={"framer-50ije7"} data-framer-name={"Video"} style={{ borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                        <div className={"framer-960oh7-container"}>
                          <article style={{ position: "relative", width: "100%", height: "100%", borderRadius: "0px", transform: "unset", cursor: "pointer", overflow: "hidden" }} role={"presentation"}>
                            <link rel={"preconnect"} href={"https://i.ytimg.com"} />
                            <img decoding={"async"} src={"https://i.ytimg.com/vi_webp/atycPTJ6LWk/sddefault.webp"} style={{ position: "absolute", top: "0", left: "0", height: "100%", width: "100%", objectFit: "cover" }} />
                            <iframe loading={"lazy"} style={{ position: "absolute", top: "0", left: "0", height: "100%", width: "100%", display: "none" }} title={"Youtube Video"} allow={"presentation; fullscreen; accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"} src={"https://www.youtube.com/embed/atycPTJ6LWk?v=atycPTJ6LWk&list=PLTDgOUcX23hZDQpj3ZSK-YqHXjoVNqhdO&index=2&iv_load_policy=3&rel=0&modestbranding=1&playsinline=1&autoplay=0"} frameBorder={"0"} />
                            <button aria-label={"Play"} style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "68px", height: "48px", padding: "0", border: "none", background: "transparent", cursor: "pointer" }}>
                              <svg height={"100%"} version={"1.1"} viewBox={"0 0 68 48"} width={"100%"}>
                                <path d={"M66.52,7.74c-0.78-2.93-2.49-5.41-5.42-6.19C55.79,.13,34,0,34,0S12.21,.13,6.9,1.55 C3.97,2.33,2.27,4.81,1.48,7.74C0.06,13.05,0,24,0,24s0.06,10.95,1.48,16.26c0.78,2.93,2.49,5.41,5.42,6.19 C12.21,47.87,34,48,34,48s21.79-0.13,27.1-1.55c2.93-0.78,4.64-3.26,5.42-6.19C67.94,34.95,68,24,68,24S67.94,13.05,66.52,7.74z"} fill={"#212121"} fillOpacity={"0.8"} style={{ transition: "fill .1s cubic-bezier(0.4, 0, 1, 1), fill-opacity .1s cubic-bezier(0.4, 0, 1, 1)" }} />
                                <path d={"M 45,24 27,14 27,34"} fill={"#fff"} />
              ...
              <div className={"framer-7wwytu-container"} />
            </div>
            <div className={"framer-hxobbd"} data-framer-name={"Union"} name={"Union"}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
            ...
            <div className={"framer-skquly"} data-framer-name={"Star "} name={"Star "}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
            ...
            <div className={"framer-wqfua0"} data-framer-name={"Title"} name={"Title"}>
              <div data-framer-name={"Star"} name={"Star"} className={"framer-1bgj862"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
                <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                  <svg style={{ width: "100%", height: "100%" }} viewBox={"0 0 25 25"}>
                    <use href={"#svg76722627_457"} />
                  </svg>
            ...
            <div className={"framer-munili"}>
              <div className={"framer-6pjn0f"}>
                <div className={"ssr-variant hidden-1n9l4rf"}>
                  <div className={"framer-43m88t-container"}>
                    <div className={"framer-GOmex framer-Ba2hu framer-5BS8D framer-WGJ4M framer-47Dft framer-U5AuS framer-TCv20 framer-JIYi9 framer-OdaN4 framer-1rg7xd9 framer-v-rry460"} data-border={"true"} data-framer-name={"No Video"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                      <div className={"framer-9jm81x"} data-framer-name={"Content Wrapper"}>
                        <div className={"framer-1yfbyme"} data-framer-name={"Profile & Position"}>
                          <div className={"framer-1vshqq3"} data-framer-name={"Profile Pic"} style={{ borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"async"} src={"/assets/framerusercontent.com/images/IoOPuDBt44UEh3d6w32k3PfASM.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                            </div>
                          </div>
                          <div className={"framer-bggfd5"} data-framer-name={"Name & Program"}>
                            <div className={"framer-17cggy3"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
              ...
              <div className={"ssr-variant"}>
                <div className={"framer-3g7by7-container"} />
              </div>
            </div>
          </div>
          <div className={"framer-iw24m9-container"}>
            <div className={"ssr-variant hidden-1n9l4rf hidden-zmrcco hidden-9b123j"}>
            ...
            <div className={"ssr-variant hidden-11m9phg hidden-1n9l4rf hidden-9b123j"}>
        ...
        <div className={"framer-U5XZr framer-47Dft framer-UiBmF framer-TCv20"} id={"overlay"} />
      </div>
    </>
  );
}
