...
// Styles exacts : importer "framer-about-us.css" une seule fois (layout global).
import './framer-about-us.css';

export default function AboutUsPage() {
  return (
    <>
      <div id={"main"}>
        <div className={"framer-atGpH framer-47Dft framer-UiBmF framer-TCv20 framer-5BS8D framer-JIYi9 framer-cp8n4"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-kgslfe-container"}>
            ...
            <div className={"ssr-variant hidden-cp8n4 hidden-1qlve3g"}>
          ...
          <div className={"framer-11q5aa7"} data-framer-name={"Header"}>
            ...
            <div data-framer-name={"Star "} className={"framer-1g2k88i"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Blue "} className={"framer-1rgbb7e"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Green"} className={"framer-vy0hgc"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
          ...
          <div className={"framer-1nspk0w"} data-framer-name={"Mision & Vision Section"}>
            <div className={"framer-16bg8oc"} data-framer-name={"Mission & Vision"}>
          ...
          <section className={"framer-nhmpz6"} data-framer-name={"Founding Story"}>
            <div className={"framer-1xrqnh2"} data-framer-name={"Union"} style={{ transform: "translateY(-50%)" }}>
            ...
            <div className={"framer-1sqvwql"} data-framer-name={"Intersect"} style={{ transform: "translateY(-50%)" }}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                <img decoding={"async"} width={"93"} height={"130"} src={"/assets/framerusercontent.com/images/doLwxGxdJmrOfXL20u6BKTKKxk4_q1c557d70.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
              </div>
            </div>
            <div className={"framer-1ymcjq2"} data-framer-name={"Founding Story"}>
              ...
              <div className={"framer-9r9cmm"} data-framer-name={"Card Wrapper"}>
                <div className={"ssr-variant"}>
                  <div className={"framer-xr4qal-container"}>
                    <div className={"framer-FL2qr framer-JIYi9 framer-5BS8D framer-CvaDL framer-1t6ignn framer-v-1vkb687"} data-framer-name={"Featured"} style={{ backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                      <div className={"framer-l6x46p"} data-framer-name={"Icon"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} width={"52"} height={"52"} src={"/assets/framerusercontent.com/images/9IfucsS7KrUxngFd054UMlW8soQ_qdc6f2d49.svg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                        </div>
                      </div>
                ...
                <div className={"ssr-variant"}>
                  <div className={"framer-s0ro8e-container"}>
                    <div className={"framer-FL2qr framer-JIYi9 framer-5BS8D framer-CvaDL framer-1t6ignn framer-v-1vkb687"} data-framer-name={"Featured"} style={{ backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                      <div className={"framer-l6x46p"} data-framer-name={"Icon"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} width={"52"} height={"52"} src={"/assets/framerusercontent.com/images/uHEeN2FV5wfyPLCTLo6jm9jo8I_qdc6f2d49.svg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                        </div>
                      </div>
                      <div className={"framer-1qb9nfa"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <h5 className={"framer-text framer-styles-preset-1pa5d9r"} data-styles-preset={"kvcB0mldQ"}>
                ...
                <div className={"ssr-variant"}>
                  <div className={"framer-ht9txk-container"}>
                    <div className={"framer-FL2qr framer-JIYi9 framer-5BS8D framer-CvaDL framer-1t6ignn framer-v-1vkb687"} data-framer-name={"Featured"} style={{ backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                      <div className={"framer-l6x46p"} data-framer-name={"Icon"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} width={"52"} height={"52"} src={"/assets/framerusercontent.com/images/rSCJettd91o4WktlzjWGmjkjG8_qdc6f2d49.svg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                        </div>
                      </div>
                      <div className={"framer-1qb9nfa"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <h5 className={"framer-text framer-styles-preset-1pa5d9r"} data-styles-preset={"kvcB0mldQ"}>
                ...
                <div className={"ssr-variant"}>
                  <div className={"framer-12xv645-container"}>
                    <div className={"framer-FL2qr framer-JIYi9 framer-5BS8D framer-CvaDL framer-1t6ignn framer-v-1vkb687"} data-framer-name={"Featured"} style={{ backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                      <div className={"framer-l6x46p"} data-framer-name={"Icon"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} width={"52"} height={"52"} src={"/assets/framerusercontent.com/images/JVr97R6eVle0xzLWXUGXZio4k_qdc6f2d49.svg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                        </div>
                      </div>
                      <div className={"framer-1qb9nfa"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <h5 className={"framer-text framer-styles-preset-1pa5d9r"} data-styles-preset={"kvcB0mldQ"}>
          ...
          <section className={"framer-160np5q"} data-framer-name={"Teachers"}>
            <div className={"framer-10j2k3g"} data-framer-name={"Card Wrapper"}>
              ...
              <div className={"framer-p74599"}>
                <div className={"framer-1xu3lf"}>
                  <div className={"ssr-variant"}>
                    <div className={"framer-1bbbxof-container"}>
                      <div className={"framer-0Zxxn framer-JIYi9 framer-5BS8D framer-WGJ4M framer-47Dft framer-U5AuS framer-TCv20 framer-Ba2hu framer-OdaN4 framer-mj04j8 framer-v-mj04j8"} data-framer-name={"Variant 1"} style={{ backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                        <div className={"framer-1p98ynf"} style={{ borderBottomLeftRadius: "16px", borderBottomRightRadius: "16px", borderTopLeftRadius: "16px", borderTopRightRadius: "16px" }}>
                          <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                            <img decoding={"async"} sizes={"(min-width: 1440px) calc(max((min(max(100vw - 240px, 1px), 1440px) - 40px) / 3, 50px) - 48px), (max-width: 809.98px) calc(max(min(100vw - 40px, 1440px), 50px) - 48px), (min-width: 810px) and (max-width: 1199.98px) calc(max((min(max(100vw - 80px, 1px), 1440px) - 20px) / 2, 50px) - 48px), (min-width: 1200px) and (max-width: 1439.98px) calc(max((min(max(100vw, 1px), 1440px) - 160px) / 3, 50px) - 48px)"} srcSet={"/assets/framerusercontent.com/images/7MARqQztqNevdDLwevn1REQ1Suk_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/7MARqQztqNevdDLwevn1REQ1Suk_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/7MARqQztqNevdDLwevn1REQ1Suk_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/7MARqQztqNevdDLwevn1REQ1Suk_q6c8170cf.jpg 4096w,/assets/framerusercontent.com/images/7MARqQztqNevdDLwevn1REQ1Suk.jpg 7730w"} src={"/assets/framerusercontent.com/images/7MARqQztqNevdDLwevn1REQ1Suk.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                          </div>
                        </div>
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-1bbbxof-container"}>
                      <div className={"framer-0Zxxn framer-JIYi9 framer-5BS8D framer-WGJ4M framer-47Dft framer-U5AuS framer-TCv20 framer-Ba2hu framer-OdaN4 framer-mj04j8 framer-v-mj04j8"} data-framer-name={"Variant 1"} style={{ backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                        <div className={"framer-1p98ynf"} style={{ borderBottomLeftRadius: "16px", borderBottomRightRadius: "16px", borderTopLeftRadius: "16px", borderTopRightRadius: "16px" }}>
                          <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                            <img decoding={"async"} sizes={"(min-width: 1440px) calc(max((min(max(100vw - 240px, 1px), 1440px) - 40px) / 3, 50px) - 48px), (max-width: 809.98px) calc(max(min(100vw - 40px, 1440px), 50px) - 48px), (min-width: 810px) and (max-width: 1199.98px) calc(max((min(max(100vw - 80px, 1px), 1440px) - 20px) / 2, 50px) - 48px), (min-width: 1200px) and (max-width: 1439.98px) calc(max((min(max(100vw, 1px), 1440px) - 160px) / 3, 50px) - 48px)"} srcSet={"/assets/framerusercontent.com/images/Wh3dzw6F4ZaxRfZXAF0YXWMNA_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/Wh3dzw6F4ZaxRfZXAF0YXWMNA_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/Wh3dzw6F4ZaxRfZXAF0YXWMNA_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/Wh3dzw6F4ZaxRfZXAF0YXWMNA_q6c8170cf.jpg 4096w,/assets/framerusercontent.com/images/Wh3dzw6F4ZaxRfZXAF0YXWMNA.jpg 4752w"} src={"/assets/framerusercontent.com/images/Wh3dzw6F4ZaxRfZXAF0YXWMNA.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                          </div>
                        </div>
                        <div className={"framer-17dbx96"}>
                          <div className={"framer-ume7bb"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-1bbbxof-container"}>
                      <div className={"framer-0Zxxn framer-JIYi9 framer-5BS8D framer-WGJ4M framer-47Dft framer-U5AuS framer-TCv20 framer-Ba2hu framer-OdaN4 framer-mj04j8 framer-v-mj04j8"} data-framer-name={"Variant 1"} style={{ backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                        <div className={"framer-1p98ynf"} style={{ borderBottomLeftRadius: "16px", borderBottomRightRadius: "16px", borderTopLeftRadius: "16px", borderTopRightRadius: "16px" }}>
                          <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                            <img decoding={"async"} sizes={"(min-width: 1440px) calc(max((min(max(100vw - 240px, 1px), 1440px) - 40px) / 3, 50px) - 48px), (max-width: 809.98px) calc(max(min(100vw - 40px, 1440px), 50px) - 48px), (min-width: 810px) and (max-width: 1199.98px) calc(max((min(max(100vw - 80px, 1px), 1440px) - 20px) / 2, 50px) - 48px), (min-width: 1200px) and (max-width: 1439.98px) calc(max((min(max(100vw, 1px), 1440px) - 160px) / 3, 50px) - 48px)"} srcSet={"/assets/framerusercontent.com/images/jwFxU6e0ojmk8GkSNOX3VUJIoI_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/jwFxU6e0ojmk8GkSNOX3VUJIoI_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/jwFxU6e0ojmk8GkSNOX3VUJIoI_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/jwFxU6e0ojmk8GkSNOX3VUJIoI.jpg 4096w"} src={"/assets/framerusercontent.com/images/jwFxU6e0ojmk8GkSNOX3VUJIoI.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                          </div>
                        </div>
                        <div className={"framer-17dbx96"}>
                          <div className={"framer-ume7bb"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-1bbbxof-container"}>
                      <div className={"framer-0Zxxn framer-JIYi9 framer-5BS8D framer-WGJ4M framer-47Dft framer-U5AuS framer-TCv20 framer-Ba2hu framer-OdaN4 framer-mj04j8 framer-v-mj04j8"} data-framer-name={"Variant 1"} style={{ backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                        <div className={"framer-1p98ynf"} style={{ borderBottomLeftRadius: "16px", borderBottomRightRadius: "16px", borderTopLeftRadius: "16px", borderTopRightRadius: "16px" }}>
                          <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                            <img decoding={"async"} sizes={"(min-width: 1440px) calc(max((min(max(100vw - 240px, 1px), 1440px) - 40px) / 3, 50px) - 48px), (max-width: 809.98px) calc(max(min(100vw - 40px, 1440px), 50px) - 48px), (min-width: 810px) and (max-width: 1199.98px) calc(max((min(max(100vw - 80px, 1px), 1440px) - 20px) / 2, 50px) - 48px), (min-width: 1200px) and (max-width: 1439.98px) calc(max((min(max(100vw, 1px), 1440px) - 160px) / 3, 50px) - 48px)"} srcSet={"/assets/framerusercontent.com/images/dJNEZ1lEcOWtHbME0SkLrn9rwR8_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/dJNEZ1lEcOWtHbME0SkLrn9rwR8_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/dJNEZ1lEcOWtHbME0SkLrn9rwR8_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/dJNEZ1lEcOWtHbME0SkLrn9rwR8_q6c8170cf.jpg 4096w,/assets/framerusercontent.com/images/dJNEZ1lEcOWtHbME0SkLrn9rwR8.jpg 5254w"} src={"/assets/framerusercontent.com/images/dJNEZ1lEcOWtHbME0SkLrn9rwR8.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                          </div>
                        </div>
                        <div className={"framer-17dbx96"}>
                          <div className={"framer-ume7bb"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-1bbbxof-container"}>
                      <div className={"framer-0Zxxn framer-JIYi9 framer-5BS8D framer-WGJ4M framer-47Dft framer-U5AuS framer-TCv20 framer-Ba2hu framer-OdaN4 framer-mj04j8 framer-v-mj04j8"} data-framer-name={"Variant 1"} style={{ backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                        <div className={"framer-1p98ynf"} style={{ borderBottomLeftRadius: "16px", borderBottomRightRadius: "16px", borderTopLeftRadius: "16px", borderTopRightRadius: "16px" }}>
                          <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                            <img decoding={"async"} sizes={"(min-width: 1440px) calc(max((min(max(100vw - 240px, 1px), 1440px) - 40px) / 3, 50px) - 48px), (max-width: 809.98px) calc(max(min(100vw - 40px, 1440px), 50px) - 48px), (min-width: 810px) and (max-width: 1199.98px) calc(max((min(max(100vw - 80px, 1px), 1440px) - 20px) / 2, 50px) - 48px), (min-width: 1200px) and (max-width: 1439.98px) calc(max((min(max(100vw, 1px), 1440px) - 160px) / 3, 50px) - 48px)"} srcSet={"/assets/framerusercontent.com/images/HH8KrojyxZx6X20z1r13CSwiiWE_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/HH8KrojyxZx6X20z1r13CSwiiWE_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/HH8KrojyxZx6X20z1r13CSwiiWE_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/HH8KrojyxZx6X20z1r13CSwiiWE.jpg 3648w"} src={"/assets/framerusercontent.com/images/HH8KrojyxZx6X20z1r13CSwiiWE.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                          </div>
                        </div>
                        <div className={"framer-17dbx96"}>
                          <div className={"framer-ume7bb"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-1bbbxof-container"}>
                      <div className={"framer-0Zxxn framer-JIYi9 framer-5BS8D framer-WGJ4M framer-47Dft framer-U5AuS framer-TCv20 framer-Ba2hu framer-OdaN4 framer-mj04j8 framer-v-mj04j8"} data-framer-name={"Variant 1"} style={{ backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                        <div className={"framer-1p98ynf"} style={{ borderBottomLeftRadius: "16px", borderBottomRightRadius: "16px", borderTopLeftRadius: "16px", borderTopRightRadius: "16px" }}>
                          <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                            <img decoding={"async"} sizes={"(min-width: 1440px) calc(max((min(max(100vw - 240px, 1px), 1440px) - 40px) / 3, 50px) - 48px), (max-width: 809.98px) calc(max(min(100vw - 40px, 1440px), 50px) - 48px), (min-width: 810px) and (max-width: 1199.98px) calc(max((min(max(100vw - 80px, 1px), 1440px) - 20px) / 2, 50px) - 48px), (min-width: 1200px) and (max-width: 1439.98px) calc(max((min(max(100vw, 1px), 1440px) - 160px) / 3, 50px) - 48px)"} srcSet={"/assets/framerusercontent.com/images/kIBiy2xM79Ac692vRBBeMc3YFw8_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/kIBiy2xM79Ac692vRBBeMc3YFw8_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/kIBiy2xM79Ac692vRBBeMc3YFw8_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/kIBiy2xM79Ac692vRBBeMc3YFw8_q6c8170cf.jpg 4096w,/assets/framerusercontent.com/images/kIBiy2xM79Ac692vRBBeMc3YFw8.jpg 5184w"} src={"/assets/framerusercontent.com/images/kIBiy2xM79Ac692vRBBeMc3YFw8.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                          </div>
                        </div>
                        <div className={"framer-17dbx96"}>
                          <div className={"framer-ume7bb"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
          ...
          <div className={"framer-1aj8502"} data-framer-name={"Locations Section"}>
            <div className={"framer-tfuq5b"} data-framer-name={"School Locations"}>
              <div className={"framer-1yrq0g6"} data-framer-name={"Union"}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                  <img decoding={"async"} width={"79"} height={"131"} src={"/assets/framerusercontent.com/images/rqKzz9PpDtlsth4yi8GrW2eaBc_q49817a66.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                </div>
              </div>
              <div className={"framer-1h5q7o"} data-framer-name={"Star "}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
              ...
              <div className={"framer-jzhasb"} data-framer-name={"Title"}>
                <div data-framer-name={"Star"} className={"framer-1tpv4wo"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
                  <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
              ...
              <div className={"framer-soobxs"} data-framer-name={"Locations"}>
                <div className={"framer-1ce1cns"} data-border={"true"} data-framer-name={"Warsaw Location Card"}>
                  <div className={"framer-1yl4jz0"} data-framer-name={"Embed wrapper"}>
                    <div className={"framer-1y2dd23-container"}>
                      <div borderradius={"0"} bottomleftradius={"0"} bottomrightradius={"0"} height={"100%"} id={"Qe0xilrW8"} topleftradius={"0"} toprightradius={"0"} width={"100%"} style={{ height: "100%", width: "100%", position: "relative", display: "flex", justifyContent: "center", alignItems: "center", overflow: "hidden", borderRadius: "0px" }}>
                  ...
                  <div className={"framer-pj7t14"} data-framer-name={"Address Wrapper"}>
                    <div className={"framer-t5nl11-container"}>
                      <div style={{ display: "contents" }} />
                    </div>
                    <div className={"framer-nv1xws"} style={{ transform: "none" }}>
                  ...
                  <div className={"framer-15h1taq-container"}>
                ...
                <div className={"framer-201474"} data-border={"true"} data-framer-name={"Krakow Location Card"}>
                  <div className={"framer-rhnzvu"} data-framer-name={"Embed wrapper"}>
                    <div className={"framer-135hbrm-container"}>
                      <div borderradius={"0"} bottomleftradius={"0"} bottomrightradius={"0"} height={"100%"} id={"OL0iY5vrC"} topleftradius={"0"} toprightradius={"0"} width={"100%"} style={{ height: "100%", width: "100%", position: "relative", display: "flex", justifyContent: "center", alignItems: "center", overflow: "hidden", borderRadius: "0px" }}>
                  ...
                  <div className={"framer-7k5apz"} data-framer-name={"Address Wrapper"}>
                    <div className={"framer-18fdgso-container"}>
                      <div style={{ display: "contents" }} />
                    </div>
                    <div className={"framer-1n5if5y"} style={{ transform: "none" }}>
                      <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-alignment": "left" }}>
                        Wawel 4, 31-003 Kraków
                      </p>
                    </div>
                  </div>
                  <div className={"framer-5wg2q1-container"}>
                    <a className={"framer-3qE1p framer-CvaDL framer-TMFp6 framer-1kbhlz5 framer-v-8xagx7 framer-1hf9a6b"} data-framer-name={"Link"} href={"https://maps.app.goo.gl/JGZes2HCu9eZbn2v9"} target={"_blank"} rel={"noopener"} style={{ "--border-bottom-width": "0px", "--border-color": "rgba(0, 0, 0, 0)", "--border-left-width": "0px", "--border-right-width": "0px", "--border-style": "solid", "--border-top-width": "0px", backgroundColor: "rgba(0, 0, 0, 0)", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderTopLeftRadius: "0px", borderTopRightRadius: "0px" }}>
                      <div className={"framer-oof4xq"} style={{ "--extracted-r6o4lv": "var(--variable-reference-uryPfyK63-rNlYn_Jv1)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-uryPfyK63-rNlYn_Jv1": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", transform: "none" }}>
                        <p className={"framer-text framer-styles-preset-ee3jw3"} data-styles-preset={"d2_XrBlDp"}>
                          Itinéraire
