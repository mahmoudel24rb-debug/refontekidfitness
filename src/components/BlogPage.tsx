...
// Styles exacts : importer "framer-blog.css" une seule fois (layout global).
import './framer-blog.css';

export default function BlogPage() {
  return (
    <>
      <div id={"main"}>
        <div className={"framer-LuyoZ framer-47Dft framer-JIYi9 framer-WGJ4M framer-U5AuS framer-TCv20 framer-Ba2hu framer-5BS8D framer-OdaN4 framer-OPLWG framer-1tik6lk"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-1s43b5v-container"}>
            <div className={"ssr-variant hidden-1yygfhr hidden-1ozyafm hidden-1coynm6"}>
            ...
            <div className={"ssr-variant hidden-1coynm6 hidden-1tik6lk"}>
            ...
            <div className={"ssr-variant hidden-1yygfhr hidden-1ozyafm hidden-1tik6lk"}>
          ...
          <div className={"framer-dmrxs8"} data-framer-name={"Header"} name={"Header"}>
            <div className={"framer-radvqk"} style={{ transform: "none" }}>
              <h2 className={"framer-text framer-styles-preset-h971pb"} data-styles-preset={"CEhR1NBj_"} style={{ "--framer-text-alignment": "center" }}>
                Actualités
              </h2>
            </div>
            <div data-framer-name={"red star"} name={"red star"} className={"framer-bugyj1"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Star "} name={"Star "} className={"framer-197epyc"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Blue "} name={"Blue "} className={"framer-1as083i"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Green"} name={"Green"} className={"framer-1dola9j"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
          ...
          <div className={"framer-1yeq4dp"} data-framer-name={"Blogs"} name={"Blogs"}>
            <div className={"framer-1xq8238"}>
              <div className={"framer-sl4n0b"}>
                <div className={"ssr-variant"}>
                  <div className={"framer-1d8nobg"}>
                    <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                      <img decoding={"async"} sizes={"(min-width: 1440px) 350px, (min-width: 1200px) and (max-width: 1439px) 350px, (max-width: 809px) min(100vw - 40px, 1440px), (min-width: 810px) and (max-width: 1199px) 270px"} srcSet={"/assets/framerusercontent.com/images/d5Oa69djl1p0sbnD1mEip2e2s_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/d5Oa69djl1p0sbnD1mEip2e2s_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/d5Oa69djl1p0sbnD1mEip2e2s_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/d5Oa69djl1p0sbnD1mEip2e2s_q6c8170cf.jpg 4096w,/assets/framerusercontent.com/images/d5Oa69djl1p0sbnD1mEip2e2s.jpg 6552w"} src={"/assets/framerusercontent.com/images/d5Oa69djl1p0sbnD1mEip2e2s.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                    </div>
                  </div>
                </div>
                <div className={"framer-94hwpi"} data-framer-name={"Content"} name={"Content"}>
                  <div className={"framer-s7ltcx"} data-framer-name={"Title"} style={{ transform: "none" }}>
                  ...
                  <div className={"framer-19fzh0a"} data-framer-name={"Description"} style={{ transform: "none" }}>
                    <p className={"framer-text framer-styles-preset-1k2s06t"}>
                      The Little Learners Kindergarten, play is more than just a fun activity—it's a key element of learning. Through play, children develop critical thinking, social skills, and creativity. Discover how we incorporate purposeful play into our curriculum to help young minds grow and flourish.
                    </p>
                  </div>
                  <div className={"ssr-variant"}>
                    <div className={"framer-1ksms16-container"}>
                      <a className={"framer-3qE1p framer-CvaDL framer-TMFp6 framer-1kbhlz5 framer-v-8xagx7 framer-1hf9a6b"} data-framer-name={"Link"} href={"./blog/building-bright-futures-the-lifelong-benefits-of-early-childhood-education"} style={{ "--border-bottom-width": "0px", "--border-color": "rgba(0, 0, 0, 0)", "--border-left-width": "0px", "--border-right-width": "0px", "--border-style": "solid", "--border-top-width": "0px", backgroundColor: "rgba(0, 0, 0, 0)", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderTopLeftRadius: "0px", borderTopRightRadius: "0px" }}>
                  ...
                  <div className={"framer-v6onle"} data-framer-name={"Date"} style={{ transform: "none" }}>
                    <p className={"framer-text framer-styles-preset-1d6on7b"} data-styles-preset={"g8rJF4oHh"} style={{ "--framer-text-color": "rgb(153, 153, 153)" }} />
                  </div>
                </div>
              </div>
              <div className={"framer-sl4n0b"}>
                <div className={"ssr-variant"}>
                  <div className={"framer-1d8nobg"}>
                    <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                      <img decoding={"async"} sizes={"(min-width: 1440px) 350px, (min-width: 1200px) and (max-width: 1439px) 350px, (max-width: 809px) min(100vw - 40px, 1440px), (min-width: 810px) and (max-width: 1199px) 270px"} srcSet={"/assets/framerusercontent.com/images/T4do5Q16dkonPMU0zQu24Eff7I_qbdfb3cb8.png 512w,/assets/framerusercontent.com/images/T4do5Q16dkonPMU0zQu24Eff7I.png 936w"} src={"/assets/framerusercontent.com/images/T4do5Q16dkonPMU0zQu24Eff7I.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                    </div>
                  </div>
                </div>
                <div className={"framer-94hwpi"} data-framer-name={"Content"} name={"Content"}>
                  <div className={"framer-s7ltcx"} data-framer-name={"Title"} style={{ transform: "none" }}>
                    <h5 className={"framer-text framer-styles-preset-1pa5d9r"} data-styles-preset={"kvcB0mldQ"}>
                      Snack Time, Fun Time: Healthy Snack Ideas to Fuel Your Child's Day
                    </h5>
                  </div>
                  <div className={"framer-19fzh0a"} data-framer-name={"Description"} style={{ transform: "none" }}>
                    <p className={"framer-text framer-styles-preset-1k2s06t"}>
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-1ksms16-container"}>
                      <a className={"framer-3qE1p framer-CvaDL framer-TMFp6 framer-1kbhlz5 framer-v-8xagx7 framer-1hf9a6b"} data-framer-name={"Link"} href={"./blog/snack-time-fun-time-healthy-snack-ideas-to-fuel-your-child-s-day"} style={{ "--border-bottom-width": "0px", "--border-color": "rgba(0, 0, 0, 0)", "--border-left-width": "0px", "--border-right-width": "0px", "--border-style": "solid", "--border-top-width": "0px", backgroundColor: "rgba(0, 0, 0, 0)", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderTopLeftRadius: "0px", borderTopRightRadius: "0px" }}>
                        <div className={"framer-oof4xq"} style={{ "--extracted-r6o4lv": "var(--variable-reference-uryPfyK63-rNlYn_Jv1)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-uryPfyK63-rNlYn_Jv1": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", transform: "none" }}>
                          <p className={"framer-text framer-styles-preset-ee3jw3"} data-styles-preset={"d2_XrBlDp"}>
                            Lire la suite
                          </p>
              ...
              <div className={"framer-sl4n0b"}>
                <div className={"ssr-variant"}>
                  <div className={"framer-1d8nobg"}>
                    <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                      <img decoding={"async"} sizes={"(min-width: 1440px) 350px, (min-width: 1200px) and (max-width: 1439px) 350px, (max-width: 809px) min(100vw - 40px, 1440px), (min-width: 810px) and (max-width: 1199px) 270px"} srcSet={"/assets/framerusercontent.com/images/ZwQwbzhAZXeFpEcc7kIothevVI_qbdfb3cb8.png 512w,/assets/framerusercontent.com/images/ZwQwbzhAZXeFpEcc7kIothevVI_q1cb5febc.png 1024w,/assets/framerusercontent.com/images/ZwQwbzhAZXeFpEcc7kIothevVI_q5fcbabc4.png 2048w,/assets/framerusercontent.com/images/ZwQwbzhAZXeFpEcc7kIothevVI.png 2400w"} src={"/assets/framerusercontent.com/images/ZwQwbzhAZXeFpEcc7kIothevVI.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                    </div>
                  </div>
                </div>
                <div className={"framer-94hwpi"} data-framer-name={"Content"} name={"Content"}>
                  <div className={"framer-s7ltcx"} data-framer-name={"Title"} style={{ transform: "none" }}>
                    <h5 className={"framer-text framer-styles-preset-1pa5d9r"} data-styles-preset={"kvcB0mldQ"}>
                      Preparing for Success: How to Help Your Child Thrive in Their First Year of Kindergarten
                    </h5>
                  </div>
                  <div className={"framer-19fzh0a"} data-framer-name={"Description"} style={{ transform: "none" }}>
                    <p className={"framer-text framer-styles-preset-1k2s06t"}>
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-1ksms16-container"}>
                      <a className={"framer-3qE1p framer-CvaDL framer-TMFp6 framer-1kbhlz5 framer-v-8xagx7 framer-1hf9a6b"} data-framer-name={"Link"} href={"./blog/preparing-for-success-how-to-help-your-child-thrive-in-their-first-year-of-kindergarten"} style={{ "--border-bottom-width": "0px", "--border-color": "rgba(0, 0, 0, 0)", "--border-left-width": "0px", "--border-right-width": "0px", "--border-style": "solid", "--border-top-width": "0px", backgroundColor: "rgba(0, 0, 0, 0)", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderTopLeftRadius: "0px", borderTopRightRadius: "0px" }}>
                        <div className={"framer-oof4xq"} style={{ "--extracted-r6o4lv": "var(--variable-reference-uryPfyK63-rNlYn_Jv1)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-uryPfyK63-rNlYn_Jv1": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", transform: "none" }}>
                          <p className={"framer-text framer-styles-preset-ee3jw3"} data-styles-preset={"d2_XrBlDp"}>
                            Lire la suite
                          </p>
              ...
              <div className={"framer-sl4n0b"}>
                <div className={"ssr-variant"}>
                  <div className={"framer-1d8nobg"}>
                    <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                      <img decoding={"async"} sizes={"(min-width: 1440px) 350px, (min-width: 1200px) and (max-width: 1439px) 350px, (max-width: 809px) min(100vw - 40px, 1440px), (min-width: 810px) and (max-width: 1199px) 270px"} srcSet={"/assets/framerusercontent.com/images/VvZqLTEsMxeGWfKwJBHtVYRnxEE_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/VvZqLTEsMxeGWfKwJBHtVYRnxEE_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/VvZqLTEsMxeGWfKwJBHtVYRnxEE_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/VvZqLTEsMxeGWfKwJBHtVYRnxEE_q6c8170cf.jpg 4096w,/assets/framerusercontent.com/images/VvZqLTEsMxeGWfKwJBHtVYRnxEE.jpg 6016w"} src={"/assets/framerusercontent.com/images/VvZqLTEsMxeGWfKwJBHtVYRnxEE.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                    </div>
                  </div>
                </div>
                <div className={"framer-94hwpi"} data-framer-name={"Content"} name={"Content"}>
                  <div className={"framer-s7ltcx"} data-framer-name={"Title"} style={{ transform: "none" }}>
                    <h5 className={"framer-text framer-styles-preset-1pa5d9r"} data-styles-preset={"kvcB0mldQ"}>
                      Nurturing Young Minds: The Role of Play in Early Childhood Development
                    </h5>
                  </div>
                  <div className={"framer-19fzh0a"} data-framer-name={"Description"} style={{ transform: "none" }}>
                    <p className={"framer-text framer-styles-preset-1k2s06t"}>
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-1ksms16-container"}>
                      <a className={"framer-3qE1p framer-CvaDL framer-TMFp6 framer-1kbhlz5 framer-v-8xagx7 framer-1hf9a6b"} data-framer-name={"Link"} href={"./blog/nurturing-young-minds-the-role-of-play-in-early-childhood-development"} style={{ "--border-bottom-width": "0px", "--border-color": "rgba(0, 0, 0, 0)", "--border-left-width": "0px", "--border-right-width": "0px", "--border-style": "solid", "--border-top-width": "0px", backgroundColor: "rgba(0, 0, 0, 0)", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderTopLeftRadius: "0px", borderTopRightRadius: "0px" }}>
                        <div className={"framer-oof4xq"} style={{ "--extracted-r6o4lv": "var(--variable-reference-uryPfyK63-rNlYn_Jv1)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-uryPfyK63-rNlYn_Jv1": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", transform: "none" }}>
                          <p className={"framer-text framer-styles-preset-ee3jw3"} data-styles-preset={"d2_XrBlDp"}>
                            Lire la suite
                          </p>
              ...
              <div className={"framer-1i8cyjr-container"} />
            </div>
          </div>
          <div className={"ssr-variant hidden-1yygfhr"}>
            <div className={"framer-y87p3f-container"}>
              <div className={"ssr-variant hidden-1ozyafm hidden-1coynm6"}>
              ...
              <div className={"ssr-variant hidden-1ozyafm hidden-1tik6lk"}>
          ...
          <div className={"ssr-variant hidden-1ozyafm hidden-1coynm6 hidden-1tik6lk"}>
            <div className={"framer-y87p3f-container"}>
        ...
        <div className={"framer-LuyoZ framer-47Dft framer-JIYi9 framer-WGJ4M framer-U5AuS framer-TCv20 framer-Ba2hu framer-5BS8D framer-OdaN4 framer-OPLWG"} id={"overlay"} />
      </div>
    </>
  );
}
