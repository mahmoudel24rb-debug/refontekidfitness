...
// Styles exacts : importer "framer-fees-breakdown.css" une seule fois (layout global).
import './framer-fees-breakdown.css';

export default function FeesBreakdownPage() {
  return (
    <>
      <div id={"main"}>
        <div className={"framer-UyfIH framer-47Dft framer-1ydakr6"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-wqttgy-container"}>
            <div className={"ssr-variant hidden-lk8uzl hidden-1ydm73p hidden-1j9vh8m"}>
            ...
            <div className={"ssr-variant hidden-1j9vh8m hidden-1ydakr6"}>
            ...
            <div className={"ssr-variant hidden-lk8uzl hidden-1ydm73p hidden-1ydakr6"}>
          ...
          <div className={"framer-1t6axuv"} data-framer-name={"Header"} name={"Header"}>
            ...
            <div data-framer-name={"Star "} name={"Star "} className={"framer-p36m0p"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Blue "} name={"Blue "} className={"framer-fv7zmz"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Green"} name={"Green"} className={"framer-15hxoaf"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
          ...
          <div className={"framer-ngq58x"} data-framer-name={"Testimonials"} name={"Testimonials"}>
            <div className={"framer-9v1y76"} data-framer-name={"Card Wrapper"} name={"Card Wrapper"}>
              <div className={"ssr-variant"}>
                <div className={"framer-my80mx-container"}>
                  <div className={"framer-NwvDJ framer-JIYi9 framer-9dap4v framer-v-9dap4v"} data-border={"true"} data-framer-name={"Closed"} data-highlight={"true"} tabIndex={"0"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
              ...
              <div className={"ssr-variant"}>
                <div className={"framer-bd2fed-container"}>
                  <div className={"framer-NwvDJ framer-JIYi9 framer-9dap4v framer-v-9dap4v"} data-border={"true"} data-framer-name={"Closed"} data-highlight={"true"} tabIndex={"0"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                    <div className={"framer-4gnsun"} data-framer-name={"Top"}>
                      <div className={"framer-fdp1bv"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <h5 className={"framer-text framer-styles-preset-1pa5d9r"} data-styles-preset={"kvcB0mldQ"} style={{ "--framer-text-alignment": "left" }}>
              ...
              <div className={"ssr-variant"}>
                <div className={"framer-9ie9h4-container"}>
                  <div className={"framer-NwvDJ framer-JIYi9 framer-9dap4v framer-v-9dap4v"} data-border={"true"} data-framer-name={"Closed"} data-highlight={"true"} tabIndex={"0"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                    <div className={"framer-4gnsun"} data-framer-name={"Top"}>
                      <div className={"framer-fdp1bv"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <h5 className={"framer-text framer-styles-preset-1pa5d9r"} data-styles-preset={"kvcB0mldQ"} style={{ "--framer-text-alignment": "left" }}>
              ...
              <div className={"ssr-variant"}>
                <div className={"framer-wlw1br-container"}>
                  <div className={"framer-NwvDJ framer-JIYi9 framer-9dap4v framer-v-9dap4v"} data-border={"true"} data-framer-name={"Closed"} data-highlight={"true"} tabIndex={"0"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                    <div className={"framer-4gnsun"} data-framer-name={"Top"}>
                      <div className={"framer-fdp1bv"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <h5 className={"framer-text framer-styles-preset-1pa5d9r"} data-styles-preset={"kvcB0mldQ"} style={{ "--framer-text-alignment": "left" }}>
          ...
          <div className={"ssr-variant hidden-1ydm73p"}>
            <div className={"framer-9gvn7n-container"}>
              <div className={"ssr-variant hidden-lk8uzl hidden-1j9vh8m"}>
              ...
              <div className={"ssr-variant hidden-lk8uzl hidden-1ydakr6"}>
          ...
          <div className={"ssr-variant hidden-lk8uzl hidden-1j9vh8m hidden-1ydakr6"}>
            <div className={"framer-9gvn7n-container"}>
        ...
        <div className={"framer-UyfIH framer-47Dft"} id={"overlay"} />
      </div>
    </>
  );
}
