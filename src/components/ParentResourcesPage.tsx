...
// Styles exacts : importer "framer-parent-resources.css" une seule fois (layout global).
import './framer-parent-resources.css';

export default function ParentResourcesPage() {
  return (
    <>
      <div id={"main"}>
        <div className={"framer-lFnlR framer-47Dft framer-UiBmF framer-TCv20 framer-5BS8D framer-Ba2hu framer-WGJ4M framer-U5AuS framer-JIYi9 framer-OdaN4 framer-11vvhx6"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-9co2t5-container"}>
            <div className={"ssr-variant hidden-vc0fvn hidden-uaix0y hidden-159ky6w"}>
            ...
            <div className={"ssr-variant hidden-11vvhx6 hidden-159ky6w"}>
            ...
            <div className={"ssr-variant hidden-vc0fvn hidden-11vvhx6 hidden-uaix0y"}>
          ...
          <div className={"framer-1geiwi5"} data-framer-name={"Header"} name={"Header"}>
            <div className={"framer-bt8dqh"} style={{ transform: "none" }}>
              <h2 className={"framer-text framer-styles-preset-h971pb"} data-styles-preset={"CEhR1NBj_"} style={{ "--framer-text-alignment": "center" }}>
                Parent Resources
              </h2>
            </div>
            <div data-framer-name={"red star"} name={"red star"} className={"framer-wsuj47"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Star "} name={"Star "} className={"framer-859hgr"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Blue "} name={"Blue "} className={"framer-10mf9lz"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Green"} name={"Green"} className={"framer-1mxkxi7"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
          ...
          <div className={"framer-xuqsol"} data-framer-name={"Download Resources"} name={"Download Resources"}>
            <div className={"framer-c6wq3g"} data-framer-name={"Union"} name={"Union"}>
            ...
            <div className={"framer-1z0oq5y"} data-framer-name={"Star "} name={"Star "}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
            ...
            <div className={"framer-smhwzg"} data-framer-name={"Title"} name={"Title"}>
              <div data-framer-name={"Star"} name={"Star"} className={"framer-enycnz"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
                <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
              ...
              <div className={"framer-bxxkqa"} style={{ transform: "none" }}>
            ...
            <div className={"framer-45k52a"} data-framer-name={"Card Wrapper"} name={"Card Wrapper"}>
              <div className={"ssr-variant hidden-uaix0y"}>
                <div className={"framer-fiwswv-container"}>
                  <div className={"framer-32Pfm framer-d0na3 framer-5BS8D framer-1g2bphe framer-v-9qgt3v"} data-border={"true"} data-framer-name={"Download Card"} style={{ "--1ke5a1f": "auto", "--1ku1yir": "row", "--1qi5md0": "1 0 0px", "--1wkrd1": "stretch", "--29fb3t": "1px", "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                    ...
                    <div className={"framer-keg3oq"} data-framer-name={"Price Tag"}>
                      <div className={"framer-1xz4d8g-container"}>
                        <a target={"_blank"} download={"file.txt"} title={"Download File"} style={{ gap: "5px", fontSize: "16px", lineHeight: "24px", fontFamily: "&quot", fontWeight: "600", width: "max-content", display: "flex", placeItems: "center", placeContent: "left", textDecoration: "none", fontStyle: "normal", letterSpacing: "0em", padding: "12px 24px 12px 24px", color: "rgb(255, 255, 255)", backgroundColor: "rgb(17, 17, 17)", borderRadius: "12px", userSelect: "none", whiteSpace: "nowrap", cursor: "auto" }}>
                          <svg style={{ order: "2", flexShrink: "0" }} xmlns={"http://www.w3.org/2000/svg"} width={"16"} height={"16"} fill={"rgb(255, 255, 255)"} viewBox={"0 0 256 256"}>
              ...
              <div className={"ssr-variant hidden-vc0fvn hidden-11vvhx6 hidden-159ky6w"}>
                <div className={"framer-fiwswv-container"}>
                  <div className={"framer-32Pfm framer-d0na3 framer-5BS8D framer-1g2bphe framer-v-1sagp72"} data-border={"true"} data-framer-name={"Download Phone"} style={{ "--1ke5a1f": "1px", "--1ku1yir": "column", "--29fb3t": "100%", "--9pfrjt": "1 0 0px", "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                    <div className={"framer-y4arny"} data-framer-name={"Text"}>
                      <div className={"framer-1gh1w9m"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <h6 className={"framer-text framer-styles-preset-1nokzbz"} data-styles-preset={"yqhfyPQLe"}>
                          Parent Handbook
              ...
              <div className={"ssr-variant hidden-uaix0y"}>
                <div className={"framer-1ohklku-container"}>
                  <div className={"framer-32Pfm framer-d0na3 framer-5BS8D framer-1g2bphe framer-v-9qgt3v"} data-border={"true"} data-framer-name={"Download Card"} style={{ "--1ke5a1f": "auto", "--1ku1yir": "row", "--1qi5md0": "1 0 0px", "--1wkrd1": "stretch", "--29fb3t": "1px", "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                    <div className={"framer-y4arny"} data-framer-name={"Text"}>
                      <div className={"framer-1gh1w9m"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <h6 className={"framer-text framer-styles-preset-1nokzbz"} data-styles-preset={"yqhfyPQLe"}>
              ...
              <div className={"ssr-variant hidden-uaix0y"}>
                <div className={"framer-1neft1e-container"}>
                  <div className={"framer-32Pfm framer-d0na3 framer-5BS8D framer-1g2bphe framer-v-9qgt3v"} data-border={"true"} data-framer-name={"Download Card"} style={{ "--1ke5a1f": "auto", "--1ku1yir": "row", "--1qi5md0": "1 0 0px", "--1wkrd1": "stretch", "--29fb3t": "1px", "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                    <div className={"framer-y4arny"} data-framer-name={"Text"}>
                      <div className={"framer-1gh1w9m"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <h6 className={"framer-text framer-styles-preset-1nokzbz"} data-styles-preset={"yqhfyPQLe"}>
              ...
              <div className={"ssr-variant hidden-uaix0y"}>
                <div className={"framer-ccxguf-container"}>
                  <div className={"framer-32Pfm framer-d0na3 framer-5BS8D framer-1g2bphe framer-v-9qgt3v"} data-border={"true"} data-framer-name={"Download Card"} style={{ "--1ke5a1f": "auto", "--1ku1yir": "row", "--1qi5md0": "1 0 0px", "--1wkrd1": "stretch", "--29fb3t": "1px", "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                    <div className={"framer-y4arny"} data-framer-name={"Text"}>
                      <div className={"framer-1gh1w9m"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <h6 className={"framer-text framer-styles-preset-1nokzbz"} data-styles-preset={"yqhfyPQLe"}>
            ...
            <div className={"framer-1wg5bnr"} data-framer-name={"Intersect"} name={"Intersect"} style={{ transform: "translateY(-50%)" }}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
          ...
          <div className={"framer-1axt0l1"} data-framer-name={"Subscribe Newsletter"} name={"Subscribe Newsletter"}>
            <div className={"framer-n729fp"} data-framer-name={"Union"} name={"Union"}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                <img decoding={"async"} width={"79"} height={"131"} src={"/assets/framerusercontent.com/images/rqKzz9PpDtlsth4yi8GrW2eaBc.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
              </div>
            </div>
            <div className={"framer-17ce2ob"} data-framer-name={"Star "} name={"Star "}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                <img decoding={"async"} width={"75"} height={"75"} src={"/assets/framerusercontent.com/images/fy7nkCD9bdBRf83DFU0xRVtWZFk.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
              </div>
            </div>
            ...
            <div className={"framer-21tglo"} data-framer-name={"Intersect"} name={"Intersect"} style={{ transform: "translateY(-50%)" }}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                <img decoding={"async"} width={"93"} height={"130"} src={"/assets/framerusercontent.com/images/doLwxGxdJmrOfXL20u6BKTKKxk4.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
              </div>
            </div>
            <form className={"framer-u4naja"}>
              <label className={"framer-1b86hqz"}>
                <div className={"framer-109assj"} style={{ transform: "none" }}>
                  <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                    Email Address
                  </p>
                </div>
                <div className={"framer-form-text-input framer-form-input-wrapper framer-1lwlvxf"}>
              ...
              <div className={"ssr-variant"}>
                <div className={"framer-51hqp3-container"}>
          ...
          <div className={"framer-1hirmhi"} data-framer-name={"Daily Newsletter"} name={"Daily Newsletter"}>
            <div className={"framer-44nzw7"} data-framer-name={"Content Wrapper"} name={"Content Wrapper"}>
              <div className={"framer-9n0rtc"} data-framer-name={"Title"} name={"Title"}>
                <div data-framer-name={"Star"} name={"Star"} className={"framer-q3hthk"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
                  <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                    <svg style={{ width: "100%", height: "100%" }} viewBox={"0 0 25 25"}>
                      <use href={"#svg76722627_457"} />
                    </svg>
              ...
              <div className={"framer-15sh3rk"}>
                <div className={"framer-1yduyon"}>
                  <div className={"framer-v0i43m"} data-border={"true"} data-framer-name={"News Card"} name={"News Card"}>
                    <div className={"ssr-variant hidden-vc0fvn"}>
                      <div className={"framer-vhom8g"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} width={"4000"} height={"6000"} sizes={"(min-width: 1440px) 200px, (min-width: 1200px) and (max-width: 1439px) 200px, (min-width: 810px) and (max-width: 1199px) 160px, (max-width: 809px) 180px"} srcSet={"/assets/framerusercontent.com/images/ySq0ztB2zCPGBGy9vQCL7UGPAE_q1cb5febc.jpg 682w,/assets/framerusercontent.com/images/ySq0ztB2zCPGBGy9vQCL7UGPAE_q5fcbabc4.jpg 1365w,/assets/framerusercontent.com/images/ySq0ztB2zCPGBGy9vQCL7UGPAE_q6c8170cf.jpg 2730w,/assets/framerusercontent.com/images/ySq0ztB2zCPGBGy9vQCL7UGPAE.jpg 4000w"} src={"/assets/framerusercontent.com/images/ySq0ztB2zCPGBGy9vQCL7UGPAE.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                        </div>
                      </div>
                    </div>
                    <div className={"ssr-variant hidden-11vvhx6 hidden-uaix0y hidden-159ky6w"}>
                      <div className={"framer-vhom8g"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} width={"4000"} height={"6000"} sizes={"(min-width: 1440px) 200px, (min-width: 1200px) and (max-width: 1439px) 200px, (min-width: 810px) and (max-width: 1199px) 160px, (max-width: 809px) 180px"} srcSet={"/assets/framerusercontent.com/images/ySq0ztB2zCPGBGy9vQCL7UGPAE_q1cb5febc.jpg 682w,/assets/framerusercontent.com/images/ySq0ztB2zCPGBGy9vQCL7UGPAE_q5fcbabc4.jpg 1365w,/assets/framerusercontent.com/images/ySq0ztB2zCPGBGy9vQCL7UGPAE_q6c8170cf.jpg 2730w,/assets/framerusercontent.com/images/ySq0ztB2zCPGBGy9vQCL7UGPAE.jpg 4000w"} src={"/assets/framerusercontent.com/images/ySq0ztB2zCPGBGy9vQCL7UGPAE.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "contain" }} />
                        </div>
                      </div>
                    </div>
                    <div className={"framer-18ow1l0"} data-framer-name={"Text"} name={"Text"}>
                      ...
                      <div className={"ssr-variant"}>
                        <div className={"framer-zigbej-container"}>
                      ...
                      <div className={"ssr-variant"}>
                        <div className={"framer-1yn7piq-container"}>
                          <div className={"framer-PavGF framer-OPLWG framer-hctti4 framer-v-hctti4"} data-framer-name={"Variant 1"} style={{ width: "100%" }}>
                            <div className={"framer-1uvgu4m-container"}>
                              <div style={{ display: "contents" }} />
                            </div>
                    ...
                    <div className={"ssr-variant hidden-uaix0y"}>
                      <div className={"framer-141tb4x-container"}>
                        <a className={"framer-3qE1p framer-CvaDL framer-TMFp6 framer-1kbhlz5 framer-v-1codj0b framer-1hf9a6b"} data-framer-name={"Download Button"} data-border={"true"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", borderBottomLeftRadius: "12px", borderBottomRightRadius: "12px", borderTopLeftRadius: "12px", borderTopRightRadius: "12px" }}>
                    ...
                    <div className={"ssr-variant hidden-vc0fvn hidden-11vvhx6 hidden-159ky6w"}>
                      <div className={"framer-141tb4x-container"}>
                        <a className={"framer-3qE1p framer-CvaDL framer-TMFp6 framer-1kbhlz5 framer-v-1codj0b framer-1hf9a6b"} data-framer-name={"Download Button"} data-border={"true"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", width: "100%", borderBottomLeftRadius: "12px", borderBottomRightRadius: "12px", borderTopLeftRadius: "12px", borderTopRightRadius: "12px" }}>
                          <div className={"framer-oof4xq"} style={{ "--extracted-r6o4lv": "var(--variable-reference-uryPfyK63-rNlYn_Jv1)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-uryPfyK63-rNlYn_Jv1": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", transform: "none" }}>
                            <p className={"framer-text framer-styles-preset-ee3jw3"} data-styles-preset={"d2_XrBlDp"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--variable-reference-uryPfyK63-rNlYn_Jv1))" }}>
                              Download PDF
                            </p>
                ...
                <div className={"framer-1yduyon"}>
                  <div className={"framer-v0i43m"} data-border={"true"} data-framer-name={"News Card"} name={"News Card"}>
                    <div className={"ssr-variant hidden-vc0fvn"}>
                      <div className={"framer-vhom8g"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} width={"4000"} height={"6000"} sizes={"(min-width: 1440px) 200px, (min-width: 1200px) and (max-width: 1439px) 200px, (min-width: 810px) and (max-width: 1199px) 160px, (max-width: 809px) 180px"} srcSet={"/assets/framerusercontent.com/images/pOg4QmK3cakJIsnSkURq8DKrhjE_q1cb5febc.jpg 819w,/assets/framerusercontent.com/images/pOg4QmK3cakJIsnSkURq8DKrhjE_q5fcbabc4.jpg 1638w,/assets/framerusercontent.com/images/pOg4QmK3cakJIsnSkURq8DKrhjE.jpg 2685w"} src={"/assets/framerusercontent.com/images/pOg4QmK3cakJIsnSkURq8DKrhjE.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                        </div>
                      </div>
                    </div>
                    <div className={"ssr-variant hidden-11vvhx6 hidden-uaix0y hidden-159ky6w"}>
                ...
                <div className={"framer-1yduyon"}>
                  <div className={"framer-v0i43m"} data-border={"true"} data-framer-name={"News Card"} name={"News Card"}>
                    <div className={"ssr-variant hidden-vc0fvn"}>
                      <div className={"framer-vhom8g"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} width={"4000"} height={"6000"} sizes={"(min-width: 1440px) 200px, (min-width: 1200px) and (max-width: 1439px) 200px, (min-width: 810px) and (max-width: 1199px) 160px, (max-width: 809px) 180px"} srcSet={"/assets/framerusercontent.com/images/KMRFtSA4S2vAzJh0cIJordmiA_q1cb5febc.jpg 682w,/assets/framerusercontent.com/images/KMRFtSA4S2vAzJh0cIJordmiA_q5fcbabc4.jpg 1365w,/assets/framerusercontent.com/images/KMRFtSA4S2vAzJh0cIJordmiA_q6c8170cf.jpg 2730w,/assets/framerusercontent.com/images/KMRFtSA4S2vAzJh0cIJordmiA.jpg 2848w"} src={"/assets/framerusercontent.com/images/KMRFtSA4S2vAzJh0cIJordmiA.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                        </div>
                      </div>
                    </div>
                    <div className={"ssr-variant hidden-11vvhx6 hidden-uaix0y hidden-159ky6w"}>
                    ...
                    <div className={"framer-18ow1l0"} data-framer-name={"Text"} name={"Text"}>
                      ...
                      <div className={"framer-wdwpwz"} style={{ transform: "none" }}>
                        <p className={"framer-text framer-styles-preset-1k2s06t"}>
                          Today's storytime was a magical journey with “The Very Hungry Caterpillar.” The children loved the colorful illustrations and interactive activities related to the story.
                        </p>
                      </div>
                      <div className={"framer-1lb6met"} style={{ transform: "none" }}>
                        <h6 className={"framer-text framer-styles-preset-14lyf0"} data-styles-preset={"iqdj89sBP"}>
                ...
                <div className={"framer-17peorq-container"} />
              </div>
              <div className={"framer-10ig3uz-container"}>
                <div className={"framer-PavGF framer-OPLWG framer-hctti4 framer-v-hctti4"} data-framer-name={"Variant 1"} style={{ width: "100%" }}>
                  <div className={"framer-1uvgu4m-container"}>
                    <div style={{ display: "contents" }} />
                  </div>
            ...
            <div className={"framer-19nuerl"} data-framer-name={"Union"} name={"Union"}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                <img decoding={"async"} width={"79"} height={"131"} src={"/assets/framerusercontent.com/images/rqKzz9PpDtlsth4yi8GrW2eaBc.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
              </div>
            </div>
            <div className={"framer-12u3s0h"} data-framer-name={"Star "} name={"Star "}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                <img decoding={"async"} width={"75"} height={"75"} src={"/assets/framerusercontent.com/images/fy7nkCD9bdBRf83DFU0xRVtWZFk.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
              </div>
            </div>
            <div className={"framer-1c7lqtq"} data-framer-name={"Intersect"} name={"Intersect"} style={{ transform: "translateY(-50%)" }}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                <img decoding={"async"} width={"93"} height={"130"} src={"/assets/framerusercontent.com/images/doLwxGxdJmrOfXL20u6BKTKKxk4.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
              </div>
            </div>
          </div>
          <div className={"framer-6uxq94-container"}>
            <div className={"ssr-variant hidden-vc0fvn hidden-uaix0y hidden-159ky6w"}>
        ...
        <div className={"framer-lFnlR framer-47Dft framer-UiBmF framer-TCv20 framer-5BS8D framer-Ba2hu framer-WGJ4M framer-U5AuS framer-JIYi9 framer-OdaN4"} id={"overlay"} />
      </div>
    </>
  );
}
