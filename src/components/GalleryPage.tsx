...
// Styles exacts : importer "framer-gallery.css" une seule fois (layout global).
import './framer-gallery.css';

export default function GalleryPage() {
  return (
    <>
      <div id={"main"}>
        <div className={"framer-zLmtK framer-47Dft framer-UiBmF framer-TCv20 framer-1xcbadk"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-6e6y76-container"}>
            <div className={"ssr-variant hidden-22mzem hidden-v9rwb1 hidden-piqt9i"}>
            ...
            <div className={"ssr-variant hidden-v9rwb1 hidden-piqt9i hidden-1xcbadk"}>
            ...
            <div className={"ssr-variant hidden-22mzem hidden-1xcbadk"}>
          ...
          <div className={"framer-xcwh2w"} data-framer-name={"Header"}>
            <div className={"framer-10zgo6u"} style={{ transform: "none" }}>
              <h2 className={"framer-text framer-styles-preset-h971pb"} data-styles-preset={"CEhR1NBj_"} style={{ "--framer-text-alignment": "center" }}>
                Galerie
              </h2>
            </div>
            <div data-framer-name={"red star"} className={"framer-3rq71b"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Star "} className={"framer-dn3d80"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Blue "} className={"framer-1oo685j"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Green"} className={"framer-4on9w2"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
          ...
          <div className={"framer-16xxnj9"} data-framer-name={"Gallery"}>
            <div className={"framer-cf1ujz"} data-framer-name={"Image Gallery"}>
              <div className={"framer-bafokv"} data-framer-name={"Title"}>
                <div data-framer-name={"Star"} className={"framer-1bp627v"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
                  <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
              ...
              <div className={"framer-1t0867c"}>
                <div className={"ssr-variant hidden-v9rwb1 hidden-piqt9i"}>
                  <div className={"framer-10pbiea"}>
                    <div className={"ssr-variant"}>
                      <div className={"framer-8qf245"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} sizes={"(min-width: 1440px) max((min(100vw - 240px, 1440px) - 60px) / 3, 50px), (min-width: 1200px) and (max-width: 1439.98px) max((min(100vw - 120px, 1440px) - 70px) / 3, 50px), (min-width: 810px) and (max-width: 1199.98px) max((min(100vw - 80px, 1440px) - 30px) / 2, 50px), (max-width: 809.98px) max(min(100vw - 40px, 1440px), 50px)"} srcSet={"/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI_q6c8170cf.jpg 4096w,/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI.jpg 4928w"} src={"/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className={"framer-10pbiea"}>
                    <div className={"ssr-variant"}>
                      <div className={"framer-8qf245"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} sizes={"(min-width: 1440px) max((min(100vw - 240px, 1440px) - 60px) / 3, 50px), (min-width: 1200px) and (max-width: 1439.98px) max((min(100vw - 120px, 1440px) - 70px) / 3, 50px), (min-width: 810px) and (max-width: 1199.98px) max((min(100vw - 80px, 1440px) - 30px) / 2, 50px), (max-width: 809.98px) max(min(100vw - 40px, 1440px), 50px)"} srcSet={"/assets/framerusercontent.com/images/MDpwS4Hig5AxXLBTqP3AApVwhk_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/MDpwS4Hig5AxXLBTqP3AApVwhk_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/MDpwS4Hig5AxXLBTqP3AApVwhk_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/MDpwS4Hig5AxXLBTqP3AApVwhk_q6c8170cf.jpg 4096w,/assets/framerusercontent.com/images/MDpwS4Hig5AxXLBTqP3AApVwhk.jpg 7360w"} src={"/assets/framerusercontent.com/images/MDpwS4Hig5AxXLBTqP3AApVwhk.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className={"framer-10pbiea"}>
                    <div className={"ssr-variant"}>
                      <div className={"framer-8qf245"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} sizes={"(min-width: 1440px) max((min(100vw - 240px, 1440px) - 60px) / 3, 50px), (min-width: 1200px) and (max-width: 1439.98px) max((min(100vw - 120px, 1440px) - 70px) / 3, 50px), (min-width: 810px) and (max-width: 1199.98px) max((min(100vw - 80px, 1440px) - 30px) / 2, 50px), (max-width: 809.98px) max(min(100vw - 40px, 1440px), 50px)"} srcSet={"/assets/framerusercontent.com/images/5Dlgt4iSHUuHEUiMFRT2JsiaT2Y_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/5Dlgt4iSHUuHEUiMFRT2JsiaT2Y_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/5Dlgt4iSHUuHEUiMFRT2JsiaT2Y_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/5Dlgt4iSHUuHEUiMFRT2JsiaT2Y_q6c8170cf.jpg 4096w,/assets/framerusercontent.com/images/5Dlgt4iSHUuHEUiMFRT2JsiaT2Y.jpg 12000w"} src={"/assets/framerusercontent.com/images/5Dlgt4iSHUuHEUiMFRT2JsiaT2Y.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className={"framer-10pbiea"}>
                    <div className={"ssr-variant"}>
                      <div className={"framer-8qf245"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} sizes={"(min-width: 1440px) max((min(100vw - 240px, 1440px) - 60px) / 3, 50px), (min-width: 1200px) and (max-width: 1439.98px) max((min(100vw - 120px, 1440px) - 70px) / 3, 50px), (min-width: 810px) and (max-width: 1199.98px) max((min(100vw - 80px, 1440px) - 30px) / 2, 50px)"} srcSet={"/assets/framerusercontent.com/images/y9tQt9kjf0akLCNCnt6PycB2eRc_q1cb5febc.jpg 680w,/assets/framerusercontent.com/images/y9tQt9kjf0akLCNCnt6PycB2eRc_q5fcbabc4.jpg 1360w,/assets/framerusercontent.com/images/y9tQt9kjf0akLCNCnt6PycB2eRc_q6c8170cf.jpg 2720w,/assets/framerusercontent.com/images/y9tQt9kjf0akLCNCnt6PycB2eRc.jpg 2848w"} src={"/assets/framerusercontent.com/images/y9tQt9kjf0akLCNCnt6PycB2eRc.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className={"framer-10pbiea"}>
                    <div className={"ssr-variant"}>
                      <div className={"framer-8qf245"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} src={"/assets/framerusercontent.com/images/FEik5oQNxhuIHSIJhOOEeUpuCfg.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className={"framer-10pbiea"}>
                    <div className={"ssr-variant"}>
                      <div className={"framer-8qf245"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} sizes={"(min-width: 1440px) max((min(100vw - 240px, 1440px) - 60px) / 3, 50px), (min-width: 1200px) and (max-width: 1439.98px) max((min(100vw - 120px, 1440px) - 70px) / 3, 50px)"} srcSet={"/assets/framerusercontent.com/images/kSq5js5QtnRG191g7RpcLOg8w_q1cb5febc.jpg 768w,/assets/framerusercontent.com/images/kSq5js5QtnRG191g7RpcLOg8w_q5fcbabc4.jpg 1536w,/assets/framerusercontent.com/images/kSq5js5QtnRG191g7RpcLOg8w.jpg 3024w"} src={"/assets/framerusercontent.com/images/kSq5js5QtnRG191g7RpcLOg8w.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className={"framer-10pbiea"}>
                    <div className={"ssr-variant"}>
                      <div className={"framer-8qf245"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} sizes={"(min-width: 1440px) max((min(100vw - 240px, 1440px) - 60px) / 3, 50px), (min-width: 1200px) and (max-width: 1439.98px) max((min(100vw - 120px, 1440px) - 70px) / 3, 50px)"} srcSet={"/assets/framerusercontent.com/images/XbI6qJgEg6av0lblTgO4iFcLO5I_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/XbI6qJgEg6av0lblTgO4iFcLO5I_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/XbI6qJgEg6av0lblTgO4iFcLO5I_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/XbI6qJgEg6av0lblTgO4iFcLO5I_q6c8170cf.jpg 4096w,/assets/framerusercontent.com/images/XbI6qJgEg6av0lblTgO4iFcLO5I.jpg 4288w"} src={"/assets/framerusercontent.com/images/XbI6qJgEg6av0lblTgO4iFcLO5I.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={"framer-10pbiea"}>
                    <div className={"ssr-variant"}>
                      <div className={"framer-8qf245"}>
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                          <img decoding={"async"} sizes={"(min-width: 1440px) max((min(100vw - 240px, 1440px) - 60px) / 3, 50px), (min-width: 1200px) and (max-width: 1439.98px) max((min(100vw - 120px, 1440px) - 70px) / 3, 50px)"} srcSet={"/assets/framerusercontent.com/images/xB2OxMiktUMEDAgrpHwAB3WIO2E_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/xB2OxMiktUMEDAgrpHwAB3WIO2E_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/xB2OxMiktUMEDAgrpHwAB3WIO2E_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/xB2OxMiktUMEDAgrpHwAB3WIO2E.jpg 3931w"} src={"/assets/framerusercontent.com/images/xB2OxMiktUMEDAgrpHwAB3WIO2E.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className={"framer-1vsm8q0-container"} />
                </div>
                <div className={"ssr-variant hidden-22mzem hidden-piqt9i hidden-1xcbadk"}>
                  <div className={"framer-10pbiea"}>
                    <div className={"framer-8qf245"}>
                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                        <img decoding={"async"} sizes={"(min-width: 1440px) max((min(100vw - 240px, 1440px) - 60px) / 3, 50px), (min-width: 1200px) and (max-width: 1439.98px) max((min(100vw - 120px, 1440px) - 70px) / 3, 50px), (min-width: 810px) and (max-width: 1199.98px) max((min(100vw - 80px, 1440px) - 30px) / 2, 50px), (max-width: 809.98px) max(min(100vw - 40px, 1440px), 50px)"} srcSet={"/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI_q6c8170cf.jpg 4096w,/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI.jpg 4928w"} src={"/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                  ...
                  <div className={"framer-1vsm8q0-container"}>
                    <div className={"framer-8EaGQ framer-1hbo82m framer-v-1hbo82m"} data-framer-name={"Loading"}>
                      <div className={"framer-1qrc6yg"} data-framer-name={"Spinner"} style={{ mask: "url('/assets/framerusercontent.com/images/pGiXYozQ3mE4cilNOItfe2L2fUA.svg') alpha no-repeat center / cover add", WebkitMask: "url('/assets/framerusercontent.com/images/pGiXYozQ3mE4cilNOItfe2L2fUA.svg') alpha no-repeat center / cover add", willChange: "transform", opacity: "0", transform: "none" }}>
                        <div className={"framer-1jivlv8"} data-framer-name={"Conic"} style={{ background: "conic-gradient(from 0deg at 50% 50%, rgba(255, 255, 255, 0) 0deg, rgb(153, 153, 153) 342deg)", willChange: "transform", opacity: "1", transform: "none" }}>
                          <div className={"framer-m7b4s7"} data-framer-name={"Round"} style={{ backgroundColor: "rgb(153, 153, 153)", borderBottomLeftRadius: "1px", borderBottomRightRadius: "1px", borderTopLeftRadius: "1px", borderTopRightRadius: "1px" }} />
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className={"ssr-variant hidden-22mzem hidden-v9rwb1 hidden-1xcbadk"}>
                  <div className={"framer-10pbiea"}>
                    <div className={"framer-8qf245"}>
                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                        <img decoding={"async"} sizes={"(min-width: 1440px) max((min(100vw - 240px, 1440px) - 60px) / 3, 50px), (min-width: 1200px) and (max-width: 1439.98px) max((min(100vw - 120px, 1440px) - 70px) / 3, 50px), (min-width: 810px) and (max-width: 1199.98px) max((min(100vw - 80px, 1440px) - 30px) / 2, 50px), (max-width: 809.98px) max(min(100vw - 40px, 1440px), 50px)"} srcSet={"/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI_q6c8170cf.jpg 4096w,/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI.jpg 4928w"} src={"/assets/framerusercontent.com/images/CzQ4Ak17Cag01dW9gcLhDviEDI.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
            ...
            <div className={"framer-whkd4h"} data-framer-name={"Video Gallery"}>
              <div className={"framer-qn1jag"} data-framer-name={"Title"}>
                <div data-framer-name={"Star"} className={"framer-nlg388"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
                  <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                    <svg style={{ width: "100%", height: "100%" }} viewBox={"0 0 25 25"}>
                      <use href={"#svg76722627_457"} />
                    </svg>
              ...
              <div className={"framer-455kpi"}>
                <div className={"framer-ght2qb"}>
                  <div className={"ssr-variant"}>
                    <div className={"framer-15l00uo"} data-framer-name={"Video Card"}>
                      ...
                      <div className={"framer-tgokx1-container"}>
                        <article style={{ position: "relative", width: "100%", height: "100%", borderRadius: "0px", transform: "unset", cursor: "pointer", overflow: "hidden" }} role={"presentation"}>
                          ...
                          <img decoding={"async"} src={"https://i.ytimg.com/vi_webp/yxR-R4aLmt4/sddefault.webp"} style={{ position: "absolute", top: "0", left: "0", height: "100%", width: "100%", objectFit: "cover" }} />
                          <iframe loading={"lazy"} style={{ position: "absolute", top: "0", left: "0", height: "100%", width: "100%", display: "none" }} title={"Youtube Video"} allow={"presentation; fullscreen; accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"} src={"https://www.youtube.com/embed/yxR-R4aLmt4?v=yxR-R4aLmt4&list=PLU9il4c3BBUU6iPLgqjXXtn9apt69Pz9S&index=4&iv_load_policy=3&rel=0&modestbranding=1&playsinline=1&autoplay=0"} frameBorder={"0"} />
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-15l00uo"} data-framer-name={"Video Card"}>
                      ...
                      <div className={"framer-tgokx1-container"}>
                        <article style={{ position: "relative", width: "100%", height: "100%", borderRadius: "0px", transform: "unset", cursor: "pointer", overflow: "hidden" }} role={"presentation"}>
                          <link rel={"preconnect"} href={"https://i.ytimg.com"} />
                          <img decoding={"async"} src={"https://i.ytimg.com/vi_webp/VkBnNxneA_A/sddefault.webp"} style={{ position: "absolute", top: "0", left: "0", height: "100%", width: "100%", objectFit: "cover" }} />
                          <iframe loading={"lazy"} style={{ position: "absolute", top: "0", left: "0", height: "100%", width: "100%", display: "none" }} title={"Youtube Video"} allow={"presentation; fullscreen; accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"} src={"https://www.youtube.com/embed/VkBnNxneA_A?v=VkBnNxneA_A&list=PLU9il4c3BBUU6iPLgqjXXtn9apt69Pz9S&iv_load_policy=3&rel=0&modestbranding=1&playsinline=1&autoplay=0"} frameBorder={"0"} />
                          <button aria-label={"Play"} style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "68px", height: "48px", padding: "0", border: "none", background: "transparent", cursor: "pointer" }}>
                            <svg height={"100%"} version={"1.1"} viewBox={"0 0 68 48"} width={"100%"}>
                              <path d={"M66.52,7.74c-0.78-2.93-2.49-5.41-5.42-6.19C55.79,.13,34,0,34,0S12.21,.13,6.9,1.55 C3.97,2.33,2.27,4.81,1.48,7.74C0.06,13.05,0,24,0,24s0.06,10.95,1.48,16.26c0.78,2.93,2.49,5.41,5.42,6.19 C12.21,47.87,34,48,34,48s21.79-0.13,27.1-1.55c2.93-0.78,4.64-3.26,5.42-6.19C67.94,34.95,68,24,68,24S67.94,13.05,66.52,7.74z"} fill={"#212121"} fillOpacity={"0.8"} style={{ transition: "fill .1s cubic-bezier(0.4, 0, 1, 1), fill-opacity .1s cubic-bezier(0.4, 0, 1, 1)" }} />
                              <path d={"M 45,24 27,14 27,34"} fill={"#fff"} />
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-15l00uo"} data-framer-name={"Video Card"}>
                      ...
                      <div className={"framer-tgokx1-container"}>
                        <article style={{ position: "relative", width: "100%", height: "100%", borderRadius: "0px", transform: "unset", cursor: "pointer", overflow: "hidden" }} role={"presentation"}>
                          <link rel={"preconnect"} href={"https://i.ytimg.com"} />
                          <img decoding={"async"} src={"https://i.ytimg.com/vi_webp/rVqR9num8Js/sddefault.webp"} style={{ position: "absolute", top: "0", left: "0", height: "100%", width: "100%", objectFit: "cover" }} />
                          <iframe loading={"lazy"} style={{ position: "absolute", top: "0", left: "0", height: "100%", width: "100%", display: "none" }} title={"Youtube Video"} allow={"presentation; fullscreen; accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"} src={"https://www.youtube.com/embed/rVqR9num8Js?v=rVqR9num8Js&list=PLU9il4c3BBUU6iPLgqjXXtn9apt69Pz9S&index=2&iv_load_policy=3&rel=0&modestbranding=1&playsinline=1&autoplay=0"} frameBorder={"0"} />
                          <button aria-label={"Play"} style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "68px", height: "48px", padding: "0", border: "none", background: "transparent", cursor: "pointer" }}>
                            <svg height={"100%"} version={"1.1"} viewBox={"0 0 68 48"} width={"100%"}>
                              <path d={"M66.52,7.74c-0.78-2.93-2.49-5.41-5.42-6.19C55.79,.13,34,0,34,0S12.21,.13,6.9,1.55 C3.97,2.33,2.27,4.81,1.48,7.74C0.06,13.05,0,24,0,24s0.06,10.95,1.48,16.26c0.78,2.93,2.49,5.41,5.42,6.19 C12.21,47.87,34,48,34,48s21.79-0.13,27.1-1.55c2.93-0.78,4.64-3.26,5.42-6.19C67.94,34.95,68,24,68,24S67.94,13.05,66.52,7.74z"} fill={"#212121"} fillOpacity={"0.8"} style={{ transition: "fill .1s cubic-bezier(0.4, 0, 1, 1), fill-opacity .1s cubic-bezier(0.4, 0, 1, 1)" }} />
                              <path d={"M 45,24 27,14 27,34"} fill={"#fff"} />
                ...
                <div className={"framer-1griykt-container"} />
              </div>
            </div>
            <div className={"framer-qqd5xt"} data-framer-name={"Union"}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
            ...
            <div className={"framer-ie45ay"} data-framer-name={"Star "}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
          ...
          <div className={"framer-wsqjnh-container"}>
            <div className={"ssr-variant hidden-22mzem hidden-v9rwb1 hidden-piqt9i"}>
