...
// Styles exacts : importer "framer-blog-building-bright-futures.css" une seule fois (layout global).
import './framer-blog-building-bright-futures.css';

export default function BlogBuildingBrightFutures() {
  return (
    <>
      <div id={"main"}>
        <div className={"framer-XrX80 framer-TCv20 framer-OPLWG framer-WGJ4M framer-47Dft framer-U5AuS framer-JIYi9 framer-Ba2hu framer-OdaN4 framer-M1e60 framer-h0hxtw"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"ssr-variant hidden-1nkk6mk hidden-1q9v6ug"}>
            <div className={"framer-1ei7igs-container"}>
              <div className={"ssr-variant hidden-13pk6v2"}>
              ...
              <div className={"ssr-variant hidden-h0hxtw"}>
                <nav className={"framer-8315z framer-epvch framer-v-1imvklv"} data-framer-name={"Laptop"} style={{ backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", width: "100%" }}>
                  <div className={"framer-1kmavi"} data-framer-name={"Limit"}>
                    <div className={"framer-13iyn47"} data-framer-name={"Logo & Menu"}>
                      <a data-framer-name={"Logo"} href={"../"} className={"framer-cgggxx framer-m0itgv"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
                        <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
          ...
          <div className={"ssr-variant hidden-13pk6v2 hidden-h0hxtw"}>
            <div className={"framer-1ei7igs-container"}>
              <nav className={"framer-8315z framer-epvch framer-v-wdelvt"} data-framer-name={"Phone Close"} style={{ backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", width: "100%" }}>
                <div className={"framer-1kmavi"} data-framer-name={"Limit"}>
                  <div className={"framer-13iyn47"} data-framer-name={"Logo & Menu"}>
          ...
          <div className={"framer-72y632"} data-framer-name={"Content"} name={"Content"}>
            <div className={"framer-1bwkiaf"} data-framer-name={"Blog Content"} name={"Blog Content"}>
              <div className={"framer-dl4z08"} data-framer-name={"Title"} style={{ transform: "none" }}>
                <h4 className={"framer-text framer-styles-preset-1fruokq"} data-styles-preset={"oeKkMxxkx"}>
                  Building Bright Futures: The Lifelong Benefits of Early Childhood Education
                </h4>
              </div>
              <div className={"framer-vz75e4"} data-framer-name={"Date"} style={{ transform: "none" }}>
                <p className={"framer-text framer-styles-preset-1d6on7b"} data-styles-preset={"g8rJF4oHh"} style={{ "--framer-text-alignment": "center", "--framer-text-color": "rgb(153, 153, 153)" }} />
              </div>
              <div className={"ssr-variant"}>
                <div className={"framer-3y535r"} data-framer-name={"Banner"} name={"Banner"}>
                  <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                    <img decoding={"async"} sizes={"(min-width: 1440px) max((min(100vw, 1440px) - 240px) * 0.7 - 80px, 1px), (min-width: 810px) and (max-width: 1199px) calc(min(100vw, 1440px) - 80px), (max-width: 809px) calc(min(100vw, 1440px) - 40px), (min-width: 1200px) and (max-width: 1439px) max((min(100vw, 1440px) - 120px) * 0.7 - 80px, 1px)"} srcSet={"/assets/framerusercontent.com/images/d5Oa69djl1p0sbnD1mEip2e2s_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/d5Oa69djl1p0sbnD1mEip2e2s_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/d5Oa69djl1p0sbnD1mEip2e2s_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/d5Oa69djl1p0sbnD1mEip2e2s_q6c8170cf.jpg 4096w,/assets/framerusercontent.com/images/d5Oa69djl1p0sbnD1mEip2e2s.jpg 6552w"} src={"/assets/framerusercontent.com/images/d5Oa69djl1p0sbnD1mEip2e2s.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                  </div>
                </div>
              </div>
              <div className={"framer-1moii6c"} data-framer-name={"Content"} style={{ transform: "none" }}>
                <p className={"framer-text framer-styles-preset-1d6on7b"}>
            ...
            <div className={"framer-to8fqy"} data-framer-name={"Recent Posts"} name={"Recent Posts"}>
              <div className={"framer-11pb4o0"} style={{ transform: "none" }}>
                <h5 className={"framer-text framer-styles-preset-1pa5d9r"} data-styles-preset={"kvcB0mldQ"} style={{ "--framer-text-alignment": "left" }}>
                  Articles récents
                </h5>
              </div>
              <div className={"framer-15jz07w"}>
                <div className={"framer-1b68sjz"}>
                  <div className={"ssr-variant"}>
                    <div className={"framer-1foc3wc"}>
                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                        <img decoding={"async"} sizes={"(min-width: 1440px) 106px, (min-width: 1200px) and (max-width: 1439px) 106px, (min-width: 810px) and (max-width: 1199px) 106px, (max-width: 809px) 155px"} srcSet={"/assets/framerusercontent.com/images/T4do5Q16dkonPMU0zQu24Eff7I_qbdfb3cb8.png 512w,/assets/framerusercontent.com/images/T4do5Q16dkonPMU0zQu24Eff7I.png 936w"} src={"/assets/framerusercontent.com/images/T4do5Q16dkonPMU0zQu24Eff7I.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                      </div>
                    </div>
                  </div>
                  <div className={"framer-1olypuc"} data-framer-name={"Text"} name={"Text"}>
                    <div className={"framer-1lwjnya"} data-framer-name={"Title"} style={{ transform: "none" }}>
                    ...
                    <div className={"framer-1dvi2ch-container"}>
                      <a className={"framer-3qE1p framer-CvaDL framer-TMFp6 framer-1kbhlz5 framer-v-8xagx7 framer-1hf9a6b"} data-framer-name={"Link"} href={"./snack-time-fun-time-healthy-snack-ideas-to-fuel-your-child-s-day"} style={{ "--border-bottom-width": "0px", "--border-color": "rgba(0, 0, 0, 0)", "--border-left-width": "0px", "--border-right-width": "0px", "--border-style": "solid", "--border-top-width": "0px", backgroundColor: "rgba(0, 0, 0, 0)", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderTopLeftRadius: "0px", borderTopRightRadius: "0px" }}>
                ...
                <div className={"framer-1b68sjz"}>
                  ...
                  <div className={"framer-1olypuc"} data-framer-name={"Text"} name={"Text"}>
                    ...
                    <div className={"framer-1dvi2ch-container"}>
                      <a className={"framer-3qE1p framer-CvaDL framer-TMFp6 framer-1kbhlz5 framer-v-8xagx7 framer-1hf9a6b"} data-framer-name={"Link"} href={"./preparing-for-success-how-to-help-your-child-thrive-in-their-first-year-of-kindergarten"} style={{ "--border-bottom-width": "0px", "--border-color": "rgba(0, 0, 0, 0)", "--border-left-width": "0px", "--border-right-width": "0px", "--border-style": "solid", "--border-top-width": "0px", backgroundColor: "rgba(0, 0, 0, 0)", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderTopLeftRadius: "0px", borderTopRightRadius: "0px" }}>
                        <div className={"framer-oof4xq"} style={{ "--extracted-r6o4lv": "var(--variable-reference-uryPfyK63-rNlYn_Jv1)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-uryPfyK63-rNlYn_Jv1": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", transform: "none" }}>
                          <p className={"framer-text framer-styles-preset-ee3jw3"} data-styles-preset={"d2_XrBlDp"}>
                            Lire la suite
                          </p>
                ...
                <div className={"framer-1b68sjz"}>
                  ...
                  <div className={"framer-1olypuc"} data-framer-name={"Text"} name={"Text"}>
                    ...
                    <div className={"framer-1dvi2ch-container"}>
                      <a className={"framer-3qE1p framer-CvaDL framer-TMFp6 framer-1kbhlz5 framer-v-8xagx7 framer-1hf9a6b"} data-framer-name={"Link"} href={"./nurturing-young-minds-the-role-of-play-in-early-childhood-development"} style={{ "--border-bottom-width": "0px", "--border-color": "rgba(0, 0, 0, 0)", "--border-left-width": "0px", "--border-right-width": "0px", "--border-style": "solid", "--border-top-width": "0px", backgroundColor: "rgba(0, 0, 0, 0)", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderTopLeftRadius: "0px", borderTopRightRadius: "0px" }}>
                        <div className={"framer-oof4xq"} style={{ "--extracted-r6o4lv": "var(--variable-reference-uryPfyK63-rNlYn_Jv1)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-uryPfyK63-rNlYn_Jv1": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", transform: "none" }}>
                          <p className={"framer-text framer-styles-preset-ee3jw3"} data-styles-preset={"d2_XrBlDp"}>
                            Lire la suite
                          </p>
          ...
          <div className={"ssr-variant hidden-1nkk6mk hidden-1q9v6ug"}>
            <div className={"framer-102f871-container"}>
              <div className={"ssr-variant hidden-13pk6v2"}>
          ...
          <div className={"ssr-variant hidden-1q9v6ug hidden-13pk6v2 hidden-h0hxtw"}>
            <div className={"framer-102f871-container"}>
          ...
          <div className={"ssr-variant hidden-1nkk6mk hidden-13pk6v2 hidden-h0hxtw"}>
            <div className={"framer-102f871-container"}>
        ...
        <div className={"framer-XrX80 framer-TCv20 framer-OPLWG framer-WGJ4M framer-47Dft framer-U5AuS framer-JIYi9 framer-Ba2hu framer-OdaN4 framer-M1e60"} id={"overlay"} />
      </div>
    </>
  );
}
