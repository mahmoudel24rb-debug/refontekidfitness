...
// Styles exacts : importer "framer-programs.css" une seule fois (layout global).
import './framer-programs.css';

export default function ProgramsPage() {
  return (
    <>
      <div id={"main"}>
        <div className={"framer-B4zrr framer-47Dft framer-UiBmF framer-TCv20 framer-JIYi9 framer-M1e60 framer-OPLWG framer-Ba2hu framer-135jhcj"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-14uyxa1-container"}>
            ...
            <div className={"ssr-variant hidden-t73n1m hidden-135jhcj"}>
          ...
          <div className={"framer-1xc2o2j"} data-framer-name={"Header"} name={"Header"}>
            <div className={"framer-hwsqhq"} style={{ transform: "none" }}>
              <h2 className={"framer-text framer-styles-preset-h971pb"} data-styles-preset={"CEhR1NBj_"} style={{ "--framer-text-alignment": "center" }}>
                Activités
              </h2>
            </div>
            <div data-framer-name={"red star"} name={"red star"} className={"framer-1f0q7fu"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Star "} name={"Star "} className={"framer-1o1k3yy"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Blue "} name={"Blue "} className={"framer-awhr00"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Green"} name={"Green"} className={"framer-1bqlac"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
          ...
          <div className={"framer-rt9zq0"} data-framer-name={"Content Wrapper"} name={"Content Wrapper"}>
            ...
            <div className={"framer-ltotbq"} data-framer-name={"Toddler"} name={"Toddler"}>
              <div className={"ssr-variant"}>
                <div className={"framer-1ux9t8n"}>
                  <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                    <img decoding={"async"} width={"1080"} height={"1080"} sizes={"(min-width: 1440px) 500px, (min-width: 1200px) and (max-width: 1439px) 500px, (min-width: 810px) and (max-width: 1199px) 500px, (max-width: 809px) min(100vw - 40px, 1440px)"} srcSet={"/assets/framerusercontent.com/images/NvXIQl5RERazKQ1BGgfuggDvo_q01132ea2.png 512w,/assets/framerusercontent.com/images/NvXIQl5RERazKQ1BGgfuggDvo_qa82df394.png 1024w,/assets/framerusercontent.com/images/NvXIQl5RERazKQ1BGgfuggDvo_q55dfeb19.png 1080w"} src={"/assets/framerusercontent.com/images/NvXIQl5RERazKQ1BGgfuggDvo_q55dfeb19.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "contain" }} />
                  </div>
                </div>
              </div>
              <div className={"framer-11l65y5"} data-framer-name={"Text Wrapper"} name={"Text Wrapper"}>
                <div className={"framer-gywvk0"} data-framer-name={"Top"} name={"Top"}>
                ...
                <div className={"framer-1ewcqpb"} data-framer-name={"Features"} name={"Features"}>
                  <div className={"framer-1fxj28x"} data-framer-name={"Key Features Title"} style={{ transform: "none" }}>
                    <h6 className={"framer-text framer-styles-preset-14lyf0"} data-styles-preset={"iqdj89sBP"} style={{ "--framer-text-color": "var(--token-788f6179-055e-461e-aa99-ada78aaa1519, rgb(51, 55, 91))" }}>
                      Points clés :
                    </h6>
                  </div>
                  <div className={"framer-1o5jlgd"} data-framer-name={"Feature Wrapper"} name={"Feature Wrapper"}>
                    <div className={"ssr-variant"}>
                      <div className={"framer-1ejtlf5-container"}>
                        <div className={"framer-PavGF framer-OPLWG framer-hctti4 framer-v-hctti4"} data-framer-name={"Variant 1"} style={{ width: "100%" }}>
                          <div className={"framer-1uvgu4m-container"}>
                            <div style={{ display: "contents" }} />
                          </div>
                    ...
                    <div className={"ssr-variant"}>
                      <div className={"framer-11uvf5j-container"}>
                        <div className={"framer-PavGF framer-OPLWG framer-hctti4 framer-v-hctti4"} data-framer-name={"Variant 1"} style={{ width: "100%" }}>
                          <div className={"framer-1uvgu4m-container"}>
                            <div style={{ display: "contents" }} />
                          </div>
                    ...
                    <div className={"ssr-variant"}>
                      <div className={"framer-1v70d1h-container"}>
                        <div className={"framer-PavGF framer-OPLWG framer-hctti4 framer-v-hctti4"} data-framer-name={"Variant 1"} style={{ width: "100%" }}>
                          <div className={"framer-1uvgu4m-container"}>
                            <div style={{ display: "contents" }} />
                          </div>
            ...
            <div className={"framer-zqr70"} data-framer-name={"Pre-school"} name={"Pre-school"}>
              <div className={"framer-1jny1d7"} data-framer-name={"Text Wrapper"} name={"Text Wrapper"}>
                <div className={"framer-aqmyfy"} data-framer-name={"Top"} name={"Top"}>
                ...
                <div className={"framer-5bpj2t"} data-framer-name={"Features"} name={"Features"}>
                  <div className={"framer-16q50rn"} data-framer-name={"Title"} style={{ transform: "none" }}>
                    <h6 className={"framer-text framer-styles-preset-14lyf0"} data-styles-preset={"iqdj89sBP"} style={{ "--framer-text-color": "var(--token-788f6179-055e-461e-aa99-ada78aaa1519, rgb(51, 55, 91))" }}>
                      Points clés :
                    </h6>
                  </div>
                  <div className={"framer-1k8qjkv"} data-framer-name={"Feature Wrapper"} name={"Feature Wrapper"}>
                    <div className={"ssr-variant"}>
                      <div className={"framer-1hd8mss-container"}>
                        <div className={"framer-PavGF framer-OPLWG framer-hctti4 framer-v-hctti4"} data-framer-name={"Variant 1"} style={{ width: "100%" }}>
                          <div className={"framer-1uvgu4m-container"}>
                            <div style={{ display: "contents" }} />
                          </div>
                    ...
                    <div className={"ssr-variant"}>
                      <div className={"framer-jr5p7z-container"}>
                        <div className={"framer-PavGF framer-OPLWG framer-hctti4 framer-v-hctti4"} data-framer-name={"Variant 1"} style={{ width: "100%" }}>
                          <div className={"framer-1uvgu4m-container"}>
                            <div style={{ display: "contents" }} />
                          </div>
                    ...
                    <div className={"ssr-variant"}>
                      <div className={"framer-1abo53f-container"}>
                        <div className={"framer-PavGF framer-OPLWG framer-hctti4 framer-v-hctti4"} data-framer-name={"Variant 1"} style={{ width: "100%" }}>
                          <div className={"framer-1uvgu4m-container"}>
                            <div style={{ display: "contents" }} />
                          </div>
              ...
              <div className={"ssr-variant"}>
                <div className={"framer-1ps0aes"}>
                  <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                    <img decoding={"async"} width={"1080"} height={"1080"} sizes={"(min-width: 1440px) 500px, (min-width: 1200px) and (max-width: 1439px) 500px, (min-width: 810px) and (max-width: 1199px) 500px, (max-width: 809px) min(100vw - 40px, 1440px)"} srcSet={"/assets/framerusercontent.com/images/Bdj9hcB5EsPFUvJIrCf2EcL5j3k_q01132ea2.png 512w,/assets/framerusercontent.com/images/Bdj9hcB5EsPFUvJIrCf2EcL5j3k_qa82df394.png 1024w,/assets/framerusercontent.com/images/Bdj9hcB5EsPFUvJIrCf2EcL5j3k_q55dfeb19.png 1080w"} src={"/assets/framerusercontent.com/images/Bdj9hcB5EsPFUvJIrCf2EcL5j3k_q55dfeb19.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "contain" }} />
                  </div>
                </div>
              </div>
            </div>
            <div className={"framer-1ok3gtv"} data-framer-name={"Kindergarten"} name={"Kindergarten"}>
              <div className={"ssr-variant"}>
                <div className={"framer-4zy7il"}>
                  <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                    <img decoding={"async"} width={"1080"} height={"1080"} sizes={"(min-width: 1440px) 500px, (min-width: 1200px) and (max-width: 1439px) 500px, (min-width: 810px) and (max-width: 1199px) 500px, (max-width: 809px) min(100vw - 40px, 1440px)"} srcSet={"/assets/framerusercontent.com/images/qoCJrFctKsS8qdN7tbhmqJQaQC4_q01132ea2.png 512w,/assets/framerusercontent.com/images/qoCJrFctKsS8qdN7tbhmqJQaQC4_qa82df394.png 1024w,/assets/framerusercontent.com/images/qoCJrFctKsS8qdN7tbhmqJQaQC4_q55dfeb19.png 1080w"} src={"/assets/framerusercontent.com/images/qoCJrFctKsS8qdN7tbhmqJQaQC4_q55dfeb19.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "contain" }} />
                  </div>
                </div>
              </div>
              <div className={"framer-1ef1rqy"} data-framer-name={"Text Wrapper"} name={"Text Wrapper"}>
                <div className={"framer-1pyty5u"} data-framer-name={"Top"} name={"Top"}>
                ...
                <div className={"framer-dfacko"} data-framer-name={"Features"} name={"Features"}>
                  <div className={"framer-14z6yx3"} data-framer-name={"Title"} style={{ transform: "none" }}>
                    <h6 className={"framer-text framer-styles-preset-14lyf0"} data-styles-preset={"iqdj89sBP"} style={{ "--framer-text-color": "var(--token-788f6179-055e-461e-aa99-ada78aaa1519, rgb(51, 55, 91))" }}>
                      Points clés :
                    </h6>
                  </div>
                  <div className={"ssr-variant"}>
                    <div className={"framer-g6jd7j-container"}>
                      <div className={"framer-PavGF framer-OPLWG framer-hctti4 framer-v-hctti4"} data-framer-name={"Variant 1"} style={{ width: "100%" }}>
                        <div className={"framer-1uvgu4m-container"}>
                          <div style={{ display: "contents" }} />
                        </div>
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-1fezgkk-container"}>
                      <div className={"framer-PavGF framer-OPLWG framer-hctti4 framer-v-hctti4"} data-framer-name={"Variant 1"} style={{ width: "100%" }}>
                        <div className={"framer-1uvgu4m-container"}>
                          <div style={{ display: "contents" }} />
                        </div>
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-8mijdw-container"}>
                      <div className={"framer-PavGF framer-OPLWG framer-hctti4 framer-v-hctti4"} data-framer-name={"Variant 1"} style={{ width: "100%" }}>
                        <div className={"framer-1uvgu4m-container"}>
                          <div style={{ display: "contents" }} />
                        </div>
            ...
            <div className={"framer-1fg5dk9"} data-framer-name={"Pre-K Program"} name={"Pre-K Program"}>
              <div className={"framer-sqgts0"} data-framer-name={"Text Wrapper"} name={"Text Wrapper"}>
                <div className={"framer-j9eh89"} data-framer-name={"Top"} name={"Top"}>
                ...
                <div className={"framer-1ihqi0d"} data-framer-name={"Features"} name={"Features"}>
                  <div className={"framer-14vbpm"} data-framer-name={"Title"} style={{ transform: "none" }}>
                    <h6 className={"framer-text framer-styles-preset-14lyf0"} data-styles-preset={"iqdj89sBP"} style={{ "--framer-text-color": "var(--token-788f6179-055e-461e-aa99-ada78aaa1519, rgb(51, 55, 91))" }}>
                      Points clés :
                    </h6>
                  </div>
                  <div className={"framer-1gx4p2n"} data-framer-name={"Feature Wrapper"} name={"Feature Wrapper"}>
                    <div className={"ssr-variant"}>
                      <div className={"framer-1je7ihi-container"}>
                        <div className={"framer-PavGF framer-OPLWG framer-hctti4 framer-v-hctti4"} data-framer-name={"Variant 1"} style={{ width: "100%" }}>
                          <div className={"framer-1uvgu4m-container"}>
                            <div style={{ display: "contents" }} />
                          </div>
                    ...
                    <div className={"ssr-variant"}>
                      <div className={"framer-vnyahf-container"}>
                        <div className={"framer-PavGF framer-OPLWG framer-hctti4 framer-v-hctti4"} data-framer-name={"Variant 1"} style={{ width: "100%" }}>
                          <div className={"framer-1uvgu4m-container"}>
                            <div style={{ display: "contents" }} />
                          </div>
                    ...
                    <div className={"ssr-variant"}>
                      <div className={"framer-1jfjdye-container"}>
                        <div className={"framer-PavGF framer-OPLWG framer-hctti4 framer-v-hctti4"} data-framer-name={"Variant 1"} style={{ width: "100%" }}>
                          <div className={"framer-1uvgu4m-container"}>
                            <div style={{ display: "contents" }} />
                          </div>
              ...
              <div className={"ssr-variant"}>
                <div className={"framer-1e1a602"}>
                  <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                    <img decoding={"async"} width={"1080"} height={"1080"} sizes={"(min-width: 1440px) 500px, (min-width: 1200px) and (max-width: 1439px) 500px, (min-width: 810px) and (max-width: 1199px) 500px, (max-width: 809px) min(100vw - 40px, 1440px)"} srcSet={"/assets/framerusercontent.com/images/gOc8ESsry1UTiXGk1n9LYLK7XY_q01132ea2.png 512w,/assets/framerusercontent.com/images/gOc8ESsry1UTiXGk1n9LYLK7XY_qa82df394.png 1024w,/assets/framerusercontent.com/images/gOc8ESsry1UTiXGk1n9LYLK7XY_q55dfeb19.png 1080w"} src={"/assets/framerusercontent.com/images/gOc8ESsry1UTiXGk1n9LYLK7XY_q55dfeb19.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "contain" }} />
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className={"framer-11ik4oj"} data-framer-name={"Session & Times"} name={"Session & Times"}>
            <div className={"framer-10f9ro3"} data-framer-name={"Union"} name={"Union"}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                <img decoding={"async"} width={"79"} height={"131"} src={"/assets/framerusercontent.com/images/rqKzz9PpDtlsth4yi8GrW2eaBc.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
              </div>
            </div>
            <div className={"framer-onifgp"} data-framer-name={"Star "} name={"Star "}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                <img decoding={"async"} width={"75"} height={"75"} src={"/assets/framerusercontent.com/images/fy7nkCD9bdBRf83DFU0xRVtWZFk.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
              </div>
            </div>
            ...
            <div className={"framer-vnv2mo"} data-framer-name={"Card & Button"} name={"Card & Button"}>
              <div className={"framer-8ldf4k"} data-framer-name={"Card Wrapper"} name={"Card Wrapper"}>
                <div className={"ssr-variant"}>
                  <div className={"framer-ck1i6u-container"} data-framer-name={"Session & Times "} name={"Session & Times "}>
                    <div name={"Session & Times "} className={"framer-32Pfm framer-d0na3 framer-5BS8D framer-1g2bphe framer-v-ej1gig"} data-border={"true"} data-framer-name={"Session & Times"} style={{ "--1ke5a1f": "auto", "--1ku1yir": "row", "--1qi5md0": "1 0 0px", "--1wkrd1": "stretch", "--29fb3t": "1px", "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                      ...
                      <div className={"framer-keg3oq"} data-framer-name={"Price Tag"}>
                        <div className={"framer-qxrwt3"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                          <h6 className={"framer-text framer-styles-preset-1nokzbz"} data-styles-preset={"yqhfyPQLe"}>
                            8:30 AM
                          </h6>
                        </div>
                ...
                <div className={"ssr-variant"}>
                  <div className={"framer-ykr9ut-container"} data-framer-name={"Session & Times "} name={"Session & Times "}>
                    <div name={"Session & Times "} className={"framer-32Pfm framer-d0na3 framer-5BS8D framer-1g2bphe framer-v-ej1gig"} data-border={"true"} data-framer-name={"Session & Times"} style={{ "--1ke5a1f": "auto", "--1ku1yir": "row", "--1qi5md0": "1 0 0px", "--1wkrd1": "stretch", "--29fb3t": "1px", "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                      <div className={"framer-y4arny"} data-framer-name={"Text"}>
                        <div className={"framer-1gh1w9m"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                          <h6 className={"framer-text framer-styles-preset-1nokzbz"} data-styles-preset={"yqhfyPQLe"}>
                ...
                <div className={"ssr-variant"}>
                  <div className={"framer-m29y9t-container"} data-framer-name={"Session & Times "} name={"Session & Times "}>
                    <div name={"Session & Times "} className={"framer-32Pfm framer-d0na3 framer-5BS8D framer-1g2bphe framer-v-ej1gig"} data-border={"true"} data-framer-name={"Session & Times"} style={{ "--1ke5a1f": "auto", "--1ku1yir": "row", "--1qi5md0": "1 0 0px", "--1wkrd1": "stretch", "--29fb3t": "1px", "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                      <div className={"framer-y4arny"} data-framer-name={"Text"}>
                        <div className={"framer-1gh1w9m"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                          <h6 className={"framer-text framer-styles-preset-1nokzbz"} data-styles-preset={"yqhfyPQLe"}>
                ...
                <div className={"ssr-variant"}>
                  <div className={"framer-131xpf0-container"} data-framer-name={"Session & Times "} name={"Session & Times "}>
                    <div name={"Session & Times "} className={"framer-32Pfm framer-d0na3 framer-5BS8D framer-1g2bphe framer-v-ej1gig"} data-border={"true"} data-framer-name={"Session & Times"} style={{ "--1ke5a1f": "auto", "--1ku1yir": "row", "--1qi5md0": "1 0 0px", "--1wkrd1": "stretch", "--29fb3t": "1px", "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                      <div className={"framer-y4arny"} data-framer-name={"Text"}>
                        <div className={"framer-1gh1w9m"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                          <h6 className={"framer-text framer-styles-preset-1nokzbz"} data-styles-preset={"yqhfyPQLe"}>
                ...
                <div className={"ssr-variant"}>
                  <div className={"framer-1hca8wk-container"} data-framer-name={"Session & Times "} name={"Session & Times "}>
                    <div name={"Session & Times "} className={"framer-32Pfm framer-d0na3 framer-5BS8D framer-1g2bphe framer-v-ej1gig"} data-border={"true"} data-framer-name={"Session & Times"} style={{ "--1ke5a1f": "auto", "--1ku1yir": "row", "--1qi5md0": "1 0 0px", "--1wkrd1": "stretch", "--29fb3t": "1px", "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                      <div className={"framer-y4arny"} data-framer-name={"Text"}>
                        <div className={"framer-1gh1w9m"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                          <h6 className={"framer-text framer-styles-preset-1nokzbz"} data-styles-preset={"yqhfyPQLe"}>
              ...
              <div className={"framer-1toofnt-container"}>
            ...
            <div className={"framer-1xy5mys"} data-framer-name={"Intersect"} name={"Intersect"} style={{ transform: "translateY(-50%)" }}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                <img decoding={"async"} width={"93"} height={"130"} src={"/assets/framerusercontent.com/images/doLwxGxdJmrOfXL20u6BKTKKxk4.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
              </div>
            </div>
          </div>
          <div className={"framer-956rkn"} data-framer-name={"Online Classes "} name={"Online Classes "}>
            <div className={"framer-vit5cf"} data-framer-name={"Container"} name={"Container"}>
              <div className={"framer-1qvbq86 hidden-1bj6y9j"} data-framer-name={"Union"} name={"Union"}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                  <img decoding={"async"} width={"79"} height={"131"} src={"/assets/framerusercontent.com/images/rqKzz9PpDtlsth4yi8GrW2eaBc.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                </div>
              </div>
              <div className={"framer-12n1h7q hidden-1xo6c2z"} data-framer-name={"Star "} name={"Star "}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                  <img decoding={"async"} width={"75"} height={"75"} src={"/assets/framerusercontent.com/images/fy7nkCD9bdBRf83DFU0xRVtWZFk.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                </div>
              </div>
              <div className={"framer-1qeprpn"} data-framer-name={"Title"} name={"Title"}>
                <div data-framer-name={"Star"} name={"Star"} className={"framer-193eenr"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
                  <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
              ...
              <div className={"framer-fj3oph"} data-framer-name={"Card & Button"} name={"Card & Button"}>
                <div className={"framer-1w0ztq3"}>
                  <div className={"framer-1ld2wkg"}>
                    <div className={"ssr-variant"}>
                      <div className={"framer-1lu0c1p-container"}>
                        <div className={"framer-tTqe0 framer-JIYi9 framer-5BS8D framer-CvaDL framer-1673hiu framer-v-1673hiu"} data-border={"true"} data-framer-name={"Variant 1"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                          <div className={"framer-vxoa5g"} data-framer-name={"Image"} style={{ borderBottomLeftRadius: "16px", borderBottomRightRadius: "16px", borderTopLeftRadius: "16px", borderTopRightRadius: "16px" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"async"} sizes={"(min-width: 1440px) calc(max((min(max(100vw, 1px) - 240px, 1440px) - 80px) / 3, 50px) - 48px), (max-width: 809px) calc(max(min(max(100vw, 1px) - 40px, 1440px), 50px) - 48px), (min-width: 1200px) and (max-width: 1439px) calc(max((min(max(100vw, 1px) - 120px, 1440px) - 80px) / 3, 50px) - 48px), (min-width: 810px) and (max-width: 1199px) calc(max((min(max(100vw, 1px) - 80px, 1440px) - 20px) / 2, 50px) - 48px)"} srcSet={"/assets/framerusercontent.com/images/0KD6Jf4BMuPxF071Nek8475rak_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/0KD6Jf4BMuPxF071Nek8475rak_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/0KD6Jf4BMuPxF071Nek8475rak_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/0KD6Jf4BMuPxF071Nek8475rak_q6c8170cf.jpg 4096w,/assets/framerusercontent.com/images/0KD6Jf4BMuPxF071Nek8475rak.jpg 5612w"} src={"/assets/framerusercontent.com/images/0KD6Jf4BMuPxF071Nek8475rak.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                            </div>
                          </div>
                          <div className={"framer-j9fh8m"} data-framer-name={"Text Wrapper"}>
                          ...
                          <div className={"framer-tkbcda"} data-framer-name={"Bottom"}>
                            <div className={"framer-1no8yon"} data-framer-name={"Age"}>
                              <div className={"framer-638q10"} style={{ "--extracted-r6o4lv": "var(--token-788f6179-055e-461e-aa99-ada78aaa1519, rgb(51, 55, 91))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                              ...
                              <div className={"framer-twu157"} style={{ "--extracted-r6o4lv": "var(--token-788f6179-055e-461e-aa99-ada78aaa1519, rgb(51, 55, 91))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                                <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-alignment": "center", "--framer-text-color": "var(--extracted-r6o4lv, var(--token-788f6179-055e-461e-aa99-ada78aaa1519, rgb(51, 55, 91)))" }}>
                                  1-2 years.
                                </p>
                              </div>
                            </div>
                            <div className={"framer-rfcul"} data-framer-name={"Divider"} style={{ backgroundColor: "rgba(8, 22, 70, 0.2)" }} />
                            ...
                            <div className={"framer-1q65fll"} data-framer-name={"Divider"} style={{ backgroundColor: "rgba(8, 22, 70, 0.2)" }} />
                    ...
                    <div className={"ssr-variant"}>
                      <div className={"framer-1lu0c1p-container"}>
                        <div className={"framer-tTqe0 framer-JIYi9 framer-5BS8D framer-CvaDL framer-1673hiu framer-v-1673hiu"} data-border={"true"} data-framer-name={"Variant 1"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                          <div className={"framer-vxoa5g"} data-framer-name={"Image"} style={{ borderBottomLeftRadius: "16px", borderBottomRightRadius: "16px", borderTopLeftRadius: "16px", borderTopRightRadius: "16px" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"async"} sizes={"(min-width: 1440px) calc(max((min(max(100vw, 1px) - 240px, 1440px) - 80px) / 3, 50px) - 48px), (max-width: 809px) calc(max(min(max(100vw, 1px) - 40px, 1440px), 50px) - 48px), (min-width: 1200px) and (max-width: 1439px) calc(max((min(max(100vw, 1px) - 120px, 1440px) - 80px) / 3, 50px) - 48px), (min-width: 810px) and (max-width: 1199px) calc(max((min(max(100vw, 1px) - 80px, 1440px) - 20px) / 2, 50px) - 48px)"} srcSet={"/assets/framerusercontent.com/images/sm1PU2LkmSQoomq3BIcCOARQyyM_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/sm1PU2LkmSQoomq3BIcCOARQyyM_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/sm1PU2LkmSQoomq3BIcCOARQyyM_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/sm1PU2LkmSQoomq3BIcCOARQyyM_q6c8170cf.jpg 4096w,/assets/framerusercontent.com/images/sm1PU2LkmSQoomq3BIcCOARQyyM.jpg 5760w"} src={"/assets/framerusercontent.com/images/sm1PU2LkmSQoomq3BIcCOARQyyM.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                            </div>
                          </div>
                          <div className={"framer-j9fh8m"} data-framer-name={"Text Wrapper"}>
                            <div className={"framer-13vkegw"} data-framer-name={"Title"}>
                    ...
                    <div className={"ssr-variant"}>
                      <div className={"framer-1lu0c1p-container"}>
                        <div className={"framer-tTqe0 framer-JIYi9 framer-5BS8D framer-CvaDL framer-1673hiu framer-v-1673hiu"} data-border={"true"} data-framer-name={"Variant 1"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                          <div className={"framer-vxoa5g"} data-framer-name={"Image"} style={{ borderBottomLeftRadius: "16px", borderBottomRightRadius: "16px", borderTopLeftRadius: "16px", borderTopRightRadius: "16px" }}>
                            <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                              <img decoding={"async"} sizes={"(min-width: 1440px) calc(max((min(max(100vw, 1px) - 240px, 1440px) - 80px) / 3, 50px) - 48px), (max-width: 809px) calc(max(min(max(100vw, 1px) - 40px, 1440px), 50px) - 48px), (min-width: 1200px) and (max-width: 1439px) calc(max((min(max(100vw, 1px) - 120px, 1440px) - 80px) / 3, 50px) - 48px), (min-width: 810px) and (max-width: 1199px) calc(max((min(max(100vw, 1px) - 80px, 1440px) - 20px) / 2, 50px) - 48px)"} srcSet={"/assets/framerusercontent.com/images/d8o0zRYl8AZIooLhf9sDm5Sw4Q_qbdfb3cb8.jpg 512w,/assets/framerusercontent.com/images/d8o0zRYl8AZIooLhf9sDm5Sw4Q_q1cb5febc.jpg 1024w,/assets/framerusercontent.com/images/d8o0zRYl8AZIooLhf9sDm5Sw4Q_q5fcbabc4.jpg 2048w,/assets/framerusercontent.com/images/d8o0zRYl8AZIooLhf9sDm5Sw4Q.jpg 3744w"} src={"/assets/framerusercontent.com/images/d8o0zRYl8AZIooLhf9sDm5Sw4Q.jpg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                            </div>
                          </div>
                          <div className={"framer-j9fh8m"} data-framer-name={"Text Wrapper"}>
                            <div className={"framer-13vkegw"} data-framer-name={"Title"}>
        ...
        <div className={"framer-B4zrr framer-47Dft framer-UiBmF framer-TCv20 framer-JIYi9 framer-M1e60 framer-OPLWG framer-Ba2hu"} id={"overlay"} />
      </div>
    </>
  );
}
