...
// Styles exacts : importer "framer-blog-preparing-for-success.css" une seule fois (layout global).
import './framer-blog-preparing-for-success.css';

export default function BlogPreparingForSuccess() {
  return (
    <>
      <div id={"main"}>
