...
// Styles exacts : importer "framer-admission.css" une seule fois (layout global).
import './framer-admission.css';

export default function AdmissionPage() {
  return (
    <>
      <div id={"main"}>
        <div className={"framer-NWbmM framer-47Dft framer-UiBmF framer-TCv20 framer-5BS8D framer-jx1vnc"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-42kwst-container"}>
            <div className={"ssr-variant hidden-1pzdsjq hidden-6qp4jj hidden-uumrrw"}>
            ...
            <div className={"ssr-variant hidden-jx1vnc hidden-6qp4jj hidden-uumrrw"}>
            ...
            <div className={"ssr-variant hidden-jx1vnc hidden-1pzdsjq"}>
          ...
          <div className={"framer-2buz7x"} data-framer-name={"Header"} name={"Header"}>
            ...
            <div data-framer-name={"Star "} name={"Star "} className={"framer-1fz4p8w"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Blue "} name={"Blue "} className={"framer-1jol52j"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Green"} name={"Green"} className={"framer-6r0kdx"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
          ...
          <div className={"framer-1q4tlpx"} data-framer-name={"Admission Process"} name={"Admission Process"}>
            <div className={"framer-1lhixno"} data-framer-name={"Union"} name={"Union"}>
            ...
            <div className={"framer-1ulegdj"} data-framer-name={"Title"} name={"Title"}>
              <div data-framer-name={"Star"} name={"Star"} className={"framer-xfd6af"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
                <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div className={"framer-1iaels7"} data-framer-name={"Card Wrapper"} name={"Card Wrapper"}>
              <div className={"ssr-variant hidden-6qp4jj hidden-uumrrw"}>
                <div className={"framer-1vmoei3-container"}>
                  <div className={"framer-CAV5J framer-JIYi9 framer-5BS8D framer-1030c6j framer-v-1030c6j"} data-border={"true"} data-framer-name={"Variant 1"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", height: "100%", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                    <div className={"framer-1yfvv2p"} data-framer-name={"Contact emergency"}>
                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                        <img decoding={"async"} width={"52"} height={"52"} src={"/assets/framerusercontent.com/images/rGJL7lVCev2NgZDWqR1waNudts0.svg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                      </div>
                    </div>
                    ...
                    <div className={"framer-q1e18n"} data-framer-name={"Order"} style={{ backgroundColor: "var(--token-fbb687f5-36a6-434d-ba90-5015fee6487b, rgb(255, 100, 100))", borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%", transform: "translate(-50%, -50%)" }}>
                      <div className={"framer-nkr5rw"} style={{ "--extracted-1lwpl3i": "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
              ...
              <div className={"ssr-variant hidden-6qp4jj hidden-uumrrw"}>
                <div className={"framer-z4b2zu-container"}>
                  <div className={"framer-CAV5J framer-JIYi9 framer-5BS8D framer-1030c6j framer-v-1030c6j"} data-border={"true"} data-framer-name={"Variant 1"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", height: "100%", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                    <div className={"framer-1yfvv2p"} data-framer-name={"Contact emergency"}>
                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                        <img decoding={"async"} width={"52"} height={"52"} src={"/assets/framerusercontent.com/images/y57nyfvhbr0hFhOmAwoErSOG6ik.svg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                      </div>
                    </div>
                    <div className={"framer-iv5tvc"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                      <h5 className={"framer-text framer-styles-preset-1pa5d9r"} data-styles-preset={"kvcB0mldQ"}>
              ...
              <div className={"ssr-variant hidden-6qp4jj hidden-uumrrw"}>
                <div className={"framer-lduggl-container"}>
                  <div className={"framer-CAV5J framer-JIYi9 framer-5BS8D framer-1030c6j framer-v-1030c6j"} data-border={"true"} data-framer-name={"Variant 1"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", height: "100%", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                    <div className={"framer-1yfvv2p"} data-framer-name={"Contact emergency"}>
                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                        <img decoding={"async"} width={"52"} height={"52"} src={"/assets/framerusercontent.com/images/xJO0iPAx8bQW0ljaah2op9Wjw.svg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                      </div>
                    </div>
                    <div className={"framer-iv5tvc"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                      <h5 className={"framer-text framer-styles-preset-1pa5d9r"} data-styles-preset={"kvcB0mldQ"}>
              ...
              <div className={"ssr-variant hidden-6qp4jj hidden-uumrrw"}>
                <div className={"framer-ndrj3y-container"}>
                  <div className={"framer-CAV5J framer-JIYi9 framer-5BS8D framer-1030c6j framer-v-1030c6j"} data-border={"true"} data-framer-name={"Variant 1"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", height: "100%", width: "100%", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                    <div className={"framer-1yfvv2p"} data-framer-name={"Contact emergency"}>
                      <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                        <img decoding={"async"} width={"52"} height={"52"} src={"/assets/framerusercontent.com/images/qu3MDlxYM311jkkppVMthbAOK0.svg"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                      </div>
                    </div>
                    <div className={"framer-iv5tvc"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                      <h5 className={"framer-text framer-styles-preset-1pa5d9r"} data-styles-preset={"kvcB0mldQ"}>
          ...
          <div className={"framer-djg4xu"} data-framer-name={"Program Fees"} name={"Program Fees"}>
            <div className={"framer-11np0tn"} data-framer-name={"Union"} name={"Union"}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                <img decoding={"async"} width={"79"} height={"131"} src={"/assets/framerusercontent.com/images/rqKzz9PpDtlsth4yi8GrW2eaBc.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
              </div>
            </div>
            <div className={"framer-d7v2li"} data-framer-name={"Star "} name={"Star "}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
            ...
            <div className={"framer-152jqe3"} data-framer-name={"Card Wrapper"} name={"Card Wrapper"}>
              <div className={"ssr-variant hidden-6qp4jj"}>
                <div className={"framer-1pqxt11-container"}>
                  <div className={"framer-32Pfm framer-d0na3 framer-5BS8D framer-1g2bphe framer-v-1g2bphe"} data-border={"true"} data-framer-name={"Price Card"} style={{ "--1ke5a1f": "auto", "--1ku1yir": "row", "--1qi5md0": "1 0 0px", "--1wkrd1": "stretch", "--29fb3t": "1px", "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
              ...
              <div className={"ssr-variant hidden-jx1vnc hidden-1pzdsjq hidden-uumrrw"}>
                <div className={"framer-1pqxt11-container"}>
                  <div className={"framer-32Pfm framer-d0na3 framer-5BS8D framer-1g2bphe framer-v-1g2bphe"} data-border={"true"} data-framer-name={"Price Card"} style={{ "--1ke5a1f": "1px", "--1ku1yir": "column", "--29fb3t": "100%", "--9pfrjt": "1 0 0px", "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                    <div className={"framer-y4arny"} data-framer-name={"Text"}>
                      <div className={"framer-1gh1w9m"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <h6 className={"framer-text framer-styles-preset-1nokzbz"} data-styles-preset={"yqhfyPQLe"}>
                          Toddler
              ...
              <div className={"ssr-variant hidden-6qp4jj"}>
                <div className={"framer-1veramg-container"}>
                  <div className={"framer-32Pfm framer-d0na3 framer-5BS8D framer-1g2bphe framer-v-1g2bphe"} data-border={"true"} data-framer-name={"Price Card"} style={{ "--1ke5a1f": "auto", "--1ku1yir": "row", "--1qi5md0": "1 0 0px", "--1wkrd1": "stretch", "--29fb3t": "1px", "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                    <div className={"framer-y4arny"} data-framer-name={"Text"}>
                      <div className={"framer-1gh1w9m"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <h6 className={"framer-text framer-styles-preset-1nokzbz"} data-styles-preset={"yqhfyPQLe"}>
              ...
              <div className={"ssr-variant hidden-6qp4jj"}>
                <div className={"framer-17aobn5-container"}>
                  <div className={"framer-32Pfm framer-d0na3 framer-5BS8D framer-1g2bphe framer-v-1g2bphe"} data-border={"true"} data-framer-name={"Price Card"} style={{ "--1ke5a1f": "auto", "--1ku1yir": "row", "--1qi5md0": "1 0 0px", "--1wkrd1": "stretch", "--29fb3t": "1px", "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                    <div className={"framer-y4arny"} data-framer-name={"Text"}>
                      <div className={"framer-1gh1w9m"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <h6 className={"framer-text framer-styles-preset-1nokzbz"} data-styles-preset={"yqhfyPQLe"}>
              ...
              <div className={"ssr-variant hidden-6qp4jj"}>
                <div className={"framer-1pm0rdo-container"}>
                  <div className={"framer-32Pfm framer-d0na3 framer-5BS8D framer-1g2bphe framer-v-1g2bphe"} data-border={"true"} data-framer-name={"Price Card"} style={{ "--1ke5a1f": "auto", "--1ku1yir": "row", "--1qi5md0": "1 0 0px", "--1wkrd1": "stretch", "--29fb3t": "1px", "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", maxWidth: "100%", width: "100%", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px" }}>
                    <div className={"framer-y4arny"} data-framer-name={"Text"}>
                      <div className={"framer-1gh1w9m"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                        <h6 className={"framer-text framer-styles-preset-1nokzbz"} data-styles-preset={"yqhfyPQLe"}>
            ...
            <div className={"framer-1sfpg0y-container"}>
            ...
            <div className={"framer-1qaio7j"} data-framer-name={"Intersect"} name={"Intersect"} style={{ transform: "translateY(-50%)" }}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
          ...
          <div className={"framer-1xrt7yk"} data-framer-name={"Form Section"} id={"form"} name={"Form Section"}>
            <div className={"framer-18mce63"} data-framer-name={"Get Admission"} name={"Get Admission"}>
              <div className={"framer-1ev1drj"} data-framer-name={"Title"} name={"Title"}>
                <div data-framer-name={"Star"} name={"Star"} className={"framer-1u4mtgj"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
                  <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                    <svg style={{ width: "100%", height: "100%" }} viewBox={"0 0 25 25"}>
                      <use href={"#svg76722627_457"} />
                    </svg>
                ...
                <div className={"framer-zp938f"} style={{ transform: "none" }}>
                  <h4 className={"framer-text framer-styles-preset-10ofw0b"} data-styles-preset={"Ks8ax5XhD"} style={{ "--framer-text-alignment": "center" }}>
                    Get
                  </h4>
                </div>
              ...
              <form className={"framer-1rjtspj"}>
                <label className={"framer-jzq91y"}>
                  ...
                  <div className={"framer-form-text-input framer-form-input-wrapper framer-1awee0i framer-form-text-input-type"}>
                    <input type={"text"} name={"Name"} placeholder={"Contact Person"} className={"framer-form-input framer-form-input-empty"} value={null} />
                  </div>
                </label>
                <div className={"framer-1u3e0ui"} data-framer-name={"Email & Phone"} name={"Email & Phone"}>
                ...
                <div className={"ssr-variant"}>
                  <div className={"framer-lou207-container"}>
          ...
          <div className={"framer-104qr8s-container"}>
            <div className={"ssr-variant hidden-1pzdsjq hidden-6qp4jj hidden-uumrrw"}>
            ...
            <div className={"ssr-variant hidden-jx1vnc hidden-1pzdsjq hidden-6qp4jj"}>
        ...
        <div className={"framer-NWbmM framer-47Dft framer-UiBmF framer-TCv20 framer-5BS8D"} id={"overlay"} />
      </div>
    </>
  );
}
