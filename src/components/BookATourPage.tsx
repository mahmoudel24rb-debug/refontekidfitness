...
// Styles exacts : importer "framer-book-atour.css" une seule fois (layout global).
import './framer-book-atour.css';

export default function BookATourPage() {
  return (
    <>
      <div id={"main"}>
        <div className={"framer-tNwIB framer-47Dft framer-UiBmF framer-TCv20 framer-5BS8D framer-OdaN4 framer-hJeqK framer-46bvyn"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-1thilnf"} data-framer-name={"Header"} name={"Header"}>
            <div className={"framer-10p0bm2"} style={{ transform: "none" }}>
              <h2 className={"framer-text framer-styles-preset-h971pb"} data-styles-preset={"CEhR1NBj_"} style={{ "--framer-text-alignment": "center" }}>
                Book a Tour
              </h2>
            </div>
            <div data-framer-name={"red star"} name={"red star"} className={"framer-1233xr5"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
            ...
            <div data-framer-name={"Star "} name={"Star "} className={"framer-v877e0"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Blue "} name={"Blue "} className={"framer-1g99xyj"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Green"} name={"Green"} className={"framer-15i0db5"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
          ...
          <div className={"framer-whkm58"} data-framer-name={"Form Section"} name={"Form Section"}>
            <div className={"framer-1984g43"} data-framer-name={"Contact Form"} name={"Contact Form"}>
              <div className={"framer-1wnwvpo"} data-framer-name={"Union"} name={"Union"}>
              ...
              <div className={"framer-1at9kh0"} data-framer-name={"Star "} name={"Star "}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
              ...
              <div className={"framer-11ax8zu"} data-framer-name={"Title"} name={"Title"}>
                <div data-framer-name={"Star"} name={"Star"} className={"framer-fllbxt"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
                  <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
              ...
              <div className={"framer-3zntgt"} data-framer-name={"Form & Image"} name={"Form & Image"}>
                <div className={"framer-1467tcj"} data-framer-name={"Image"} name={"Image"}>
                  <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                    <img decoding={"async"} width={"475"} height={"380"} src={"/assets/framerusercontent.com/images/FctqSiMk3BCbWEqbsE6g9HzNQWk.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "contain" }} />
                  </div>
                </div>
                <form className={"framer-1ig6wpx"}>
                  ...
                  <div className={"framer-11tqsgl"} data-framer-name={"Email & Phone"} name={"Email & Phone"}>
                    <label className={"framer-wnm799"}>
                      <div className={"framer-1edm2oh"} style={{ transform: "none" }}>
                        <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                          Email Address
                        </p>
                      </div>
                      <div className={"framer-form-text-input framer-form-input-wrapper framer-70vwwr"}>
                        <input type={"email"} name={"Email"} placeholder={"Email Address"} className={"framer-form-input framer-form-input-empty"} value={null} />
                      </div>
                    </label>
                    <label className={"framer-1jfx1i9"}>
                      <div className={"framer-187a997"} style={{ transform: "none" }}>
                        <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                          Phone
                        </p>
                      </div>
                      <div className={"framer-form-text-input framer-form-input-wrapper framer-1ogl9uv"}>
                  ...
                  <div className={"ssr-variant"}>
                    <div className={"framer-16853q7-container"}>
          ...
          <div className={"framer-gq8o60"} data-framer-name={"Contact Wrapper"} name={"Contact Wrapper"}>
            <div className={"framer-c8hz1h"} data-framer-name={"Contact Details"} name={"Contact Details"}>
              <div className={"framer-17z77cw"} data-border={"true"} data-framer-name={"Phone Number"} name={"Phone Number"}>
                <div className={"framer-99ftbm"} data-framer-name={"Icon Wrapper"} name={"Icon Wrapper"}>
                  <div className={"framer-efhq9k-container"}>
                    <div style={{ display: "contents" }} />
                  </div>
                </div>
                <div className={"framer-13no6el"} style={{ transform: "none" }}>
                  <h4 className={"framer-text framer-styles-preset-1fruokq"} data-styles-preset={"oeKkMxxkx"} style={{ "--framer-text-alignment": "center" }}>
                    Phone Number
                  </h4>
                </div>
                <div className={"framer-1x7sc84"} style={{ transform: "none" }}>
                  <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-alignment": "center" }}>
                    <a className={"framer-text framer-styles-preset-1h01746"} data-styles-preset={"jVwzG6Q9p"} href={"tel:+1 (212) 555-1234"} target={"_blank"} rel={"noopener"}>
                      +1 (212) 555-1234
                    </a>
                    (NY),
                    <a className={"framer-text framer-styles-preset-xzhtps"} data-styles-preset={"wb8jPTjF0"} href={"tel:+1 (592) 885-5235"} target={"_blank"} rel={"noopener"}>
                      +1 (592) 885-5235
                    </a>
                  </p>
                </div>
              </div>
              <div className={"framer-6j32tt"} data-border={"true"} data-framer-name={"Email"} name={"Email"}>
                <div className={"framer-of8cmj"} data-framer-name={"Icon Wrapper"} name={"Icon Wrapper"}>
                  <div className={"framer-zy0e7w-container"}>
                    <div style={{ display: "contents" }} />
                  </div>
                </div>
                <div className={"framer-17qhvuh"} style={{ transform: "none" }}>
                  <h4 className={"framer-text framer-styles-preset-1fruokq"} data-styles-preset={"oeKkMxxkx"} style={{ "--framer-text-alignment": "center" }}>
                    Email Address
                  </h4>
                </div>
                <div className={"framer-1ephaef"} style={{ transform: "none" }}>
                  <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-alignment": "center" }}>
                    <a className={"framer-text framer-styles-preset-xzhtps"} data-styles-preset={"wb8jPTjF0"} href={"mailto:admissions@nyc.edu"} target={"_blank"} rel={"noopener"}>
                      admissions@nyc.edu
                    </a>
                  </p>
                </div>
              </div>
              <div className={"framer-1orkw9i"} data-border={"true"} data-framer-name={"Office Hours"} name={"Office Hours"}>
                <div className={"framer-oxftvu"} data-framer-name={"Icon Wrapper"} name={"Icon Wrapper"}>
                  <div className={"framer-1861rym-container"}>
                    <div style={{ display: "contents" }} />
                  </div>
                </div>
                <div className={"framer-6pzq9m"} style={{ transform: "none" }}>
                  <h4 className={"framer-text framer-styles-preset-1fruokq"} data-styles-preset={"oeKkMxxkx"} style={{ "--framer-text-alignment": "center" }}>
                    Office Hour
                  </h4>
                </div>
                <div className={"framer-1r00ja"} style={{ transform: "none" }}>
                  <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-alignment": "center" }}>
          ...
          <div className={"framer-1ss0ynb-container"}>
            <div className={"ssr-variant hidden-19rgndl hidden-18ewaqq hidden-64z1r3"}>
            ...
            <div className={"ssr-variant hidden-46bvyn hidden-18ewaqq hidden-64z1r3"}>
            ...
            <div className={"ssr-variant hidden-46bvyn hidden-19rgndl hidden-64z1r3"}>
            ...
            <div className={"ssr-variant hidden-46bvyn hidden-19rgndl hidden-18ewaqq"}>
          ...
          <div className={"framer-1lix6j8-container"}>
            <div className={"ssr-variant hidden-19rgndl hidden-18ewaqq hidden-64z1r3"}>
            ...
            <div className={"ssr-variant hidden-46bvyn hidden-64z1r3"}>
        ...
        <div className={"framer-tNwIB framer-47Dft framer-UiBmF framer-TCv20 framer-5BS8D framer-OdaN4 framer-hJeqK"} id={"overlay"} />
      </div>
    </>
  );
}
