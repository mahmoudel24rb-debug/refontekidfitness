...
// Styles exacts : importer "framer-contact.css" une seule fois (layout global).
import './framer-contact.css';

export default function ContactPage() {
  return (
    <>
      <div id={"main"}>
        <div className={"framer-29W0Z framer-47Dft framer-UiBmF framer-TCv20 framer-JIYi9 framer-5BS8D framer-of2izi"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-1teed0t-container"}>
            <div className={"ssr-variant hidden-1n59o3y hidden-37gqd4 hidden-1789ns3"}>
              <nav className={"framer-8315z framer-epvch framer-v-ac3vz3"} data-framer-name={"Desktop Scroll"} style={{ backgroundColor: "var(--token-6a7314fd-fc42-4b6f-a276-ad0adb001906, rgb(251, 249, 240))", width: "100%" }}>
            ...
            <div className={"ssr-variant hidden-of2izi hidden-37gqd4"}>
            ...
            <div className={"ssr-variant hidden-1n59o3y hidden-of2izi hidden-1789ns3"}>
              <nav className={"framer-8315z framer-epvch framer-v-1imvklv"} data-framer-name={"Laptop"} style={{ backgroundColor: "var(--token-6a7314fd-fc42-4b6f-a276-ad0adb001906, rgb(251, 249, 240))", width: "100%" }}>
                <div className={"framer-1kmavi"} data-framer-name={"Limit"}>
                  <div className={"framer-13iyn47"} data-framer-name={"Logo & Menu"}>
                    <a data-framer-name={"Logo"} href={"./"} className={"framer-cgggxx framer-m0itgv"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
                      <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
          ...
          <div className={"framer-vacs23"} data-framer-name={"Header"}>
            <div className={"framer-1uig2g8"} style={{ transform: "none" }}>
              <h2 className={"framer-text framer-styles-preset-h971pb"} data-styles-preset={"CEhR1NBj_"} style={{ "--framer-text-alignment": "center" }}>
                Contact us
              </h2>
            </div>
            <div data-framer-name={"red star"} className={"framer-1obeg40"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                <svg style={{ width: "100%", height: "100%" }} viewBox={"0 0 20 20"}>
                  <use href={"#svg1386808586_1444"} />
                </svg>
              </div>
            </div>
            <div data-framer-name={"Star "} className={"framer-rv9rtx"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                <svg style={{ width: "100%", height: "100%" }} viewBox={"0 0 21 21"}>
                  <use href={"#svg-1775011470_458"} />
                </svg>
              </div>
            </div>
            <div data-framer-name={"Blue "} className={"framer-1lq4jgo"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                <svg style={{ width: "100%", height: "100%" }} viewBox={"0 0 54 54"}>
                  <use href={"#svg1343396031_358"} />
                </svg>
              </div>
            </div>
            <div data-framer-name={"Green"} className={"framer-dczu25"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                <svg style={{ width: "100%", height: "100%" }} viewBox={"0 0 24 24"}>
                  <use href={"#svg-952777423_148"} />
                </svg>
              </div>
            </div>
          </div>
          <div className={"framer-8u9fnc"} data-framer-name={"Contact Wrapper"}>
            <div className={"ssr-variant hidden-1n59o3y"}>
              <div className={"framer-1bwvlw5-container"}>
                <div className={"framer-1AkUc framer-TCv20 framer-5BS8D framer-OdaN4 framer-s9sqlz framer-v-s9sqlz"} data-framer-name={"Desktop"} style={{ width: "100%" }}>
                  <div className={"framer-z8z47m"} data-border={"true"} data-framer-name={"Phone Number"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                    <div className={"framer-1v1lpzs"} data-framer-name={"Icon Wrapper"} style={{ backgroundColor: "var(--token-fbb687f5-36a6-434d-ba90-5015fee6487b, rgb(255, 100, 100))", borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%" }}>
                      <div className={"framer-7ffbx5-container"}>
                        <div style={{ display: "contents" }} />
                      </div>
                    </div>
                    <div className={"framer-idu7lg"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                      <h4 className={"framer-text framer-styles-preset-1fruokq"} data-styles-preset={"oeKkMxxkx"} style={{ "--framer-text-alignment": "center" }}>
                        Phone Number
                      </h4>
                    </div>
                    <div className={"framer-brm039"} data-framer-name={"Tel / Email / Office Hours"}>
                      <div className={"framer-v640wu"} style={{ "--extracted-r6o4lv": "var(--variable-reference-zQk8k8QB2-GqYXtpThk)", "--variable-reference-zQk8k8QB2-GqYXtpThk": "rgb(0, 0, 0)", transform: "none" }}>
                        <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-alignment": "center", "--framer-text-color": "var(--extracted-r6o4lv, var(--variable-reference-zQk8k8QB2-GqYXtpThk))" }}>
                          <a className={"framer-text framer-styles-preset-1h01746"} data-styles-preset={"jVwzG6Q9p"}>
                            +1 (212) 555-1234
                          </a>
                        </p>
                      </div>
                  ...
                  <div className={"framer-5z919c"} data-border={"true"} data-framer-name={"Email"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                    <div className={"framer-apm3po"} data-framer-name={"Icon Wrapper"} style={{ backgroundColor: "var(--token-fbb687f5-36a6-434d-ba90-5015fee6487b, rgb(255, 100, 100))", borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%" }}>
                      <div className={"framer-sljq8-container"}>
                        <div style={{ display: "contents" }} />
                      </div>
                    </div>
                    <div className={"framer-aiudmw"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                      <h4 className={"framer-text framer-styles-preset-1fruokq"} data-styles-preset={"oeKkMxxkx"} style={{ "--framer-text-alignment": "center" }}>
                        Email Address
                      </h4>
                    </div>
                    <div className={"framer-14lw3oa"} data-framer-name={"Tel / Email / Office Hours"}>
                      <div className={"framer-gfrw3y"} style={{ "--extracted-r6o4lv": "var(--variable-reference-zQk8k8QB2-GqYXtpThk)", "--variable-reference-zQk8k8QB2-GqYXtpThk": "rgb(0, 0, 0)", transform: "none" }}>
                        <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-alignment": "center", "--framer-text-color": "var(--extracted-r6o4lv, var(--variable-reference-zQk8k8QB2-GqYXtpThk))" }}>
                          <a className={"framer-text framer-styles-preset-1h01746"} data-styles-preset={"jVwzG6Q9p"}>
                            hello@kinderly.com
                          </a>
                  ...
                  <div className={"framer-s6xdxj"} data-border={"true"} data-framer-name={"Office Hours"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                    <div className={"framer-d1ojfq"} data-framer-name={"Icon Wrapper"} style={{ backgroundColor: "var(--token-fbb687f5-36a6-434d-ba90-5015fee6487b, rgb(255, 100, 100))", borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%" }}>
                      <div className={"framer-c5zgw3-container"}>
                        <div style={{ display: "contents" }} />
                      </div>
                    </div>
                    <div className={"framer-1w2ip0b"} style={{ "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                      <h4 className={"framer-text framer-styles-preset-1fruokq"} data-styles-preset={"oeKkMxxkx"} style={{ "--framer-text-alignment": "center" }}>
                        Office Hour
                      </h4>
                    </div>
                    <div className={"framer-1q7l3pc"} data-framer-name={"Tel / Email / Office Hours"}>
                      <div className={"framer-p7vucw"} style={{ "--extracted-r6o4lv": "rgb(0, 0, 0)", transform: "none" }}>
                        <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-alignment": "center", "--framer-text-color": "var(--extracted-r6o4lv, rgb(0, 0, 0))" }}>
                          Monday to Friday: 8.30am – 04.00pm
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className={"ssr-variant hidden-of2izi hidden-37gqd4 hidden-1789ns3"}>
              <div className={"framer-1bwvlw5-container"}>
                <div className={"framer-1AkUc framer-TCv20 framer-5BS8D framer-OdaN4 framer-s9sqlz framer-v-nr67tk"} data-framer-name={"Phone"} style={{ width: "100%" }}>
                  <div className={"framer-z8z47m"} data-border={"true"} data-framer-name={"Phone Number"} style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-c2e34719-b7f3-48fe-b6dc-c98270809dd0, rgb(248, 251, 254))", borderBottomLeftRadius: "30px", borderBottomRightRadius: "30px", borderTopLeftRadius: "30px", borderTopRightRadius: "30px" }}>
                    <div className={"framer-1v1lpzs"} data-framer-name={"Icon Wrapper"} style={{ backgroundColor: "var(--token-fbb687f5-36a6-434d-ba90-5015fee6487b, rgb(255, 100, 100))", borderBottomLeftRadius: "50%", borderBottomRightRadius: "50%", borderTopLeftRadius: "50%", borderTopRightRadius: "50%" }}>
                      <div className={"framer-7ffbx5-container"}>
                        <div style={{ display: "contents" }} />
          ...
          <div className={"framer-bc3ftt"} data-framer-name={"Locations Section"}>
            <div className={"framer-w77e0q"} data-framer-name={"School Locations"}>
              <div className={"framer-6wvzum"} data-framer-name={"Union"}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                  <img decoding={"async"} width={"79"} height={"131"} src={"/assets/framerusercontent.com/images/rqKzz9PpDtlsth4yi8GrW2eaBc_q49817a66.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                </div>
              </div>
              <div className={"framer-1avrqng"} data-framer-name={"Star "}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                  <img decoding={"async"} width={"75"} height={"75"} src={"/assets/framerusercontent.com/images/fy7nkCD9bdBRf83DFU0xRVtWZFk_q80f96b68.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                </div>
              </div>
              <div className={"framer-1h02gcb"} data-framer-name={"Title"}>
                <div data-framer-name={"Star"} className={"framer-y6glr1"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
                  <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                    <svg style={{ width: "100%", height: "100%" }} viewBox={"0 0 25 25"}>
                      <use href={"#svg76722627_457"} />
                    </svg>
                  </div>
                </div>
                <div className={"framer-1vm7j5"} style={{ transform: "none" }}>
                  <h4 className={"framer-text framer-styles-preset-10ofw0b"} data-styles-preset={"Ks8ax5XhD"} style={{ "--framer-text-alignment": "center" }}>
                    School
                  </h4>
                </div>
                <div className={"framer-tqtzya"} style={{ transform: "none" }}>
                  <h4 className={"framer-text framer-styles-preset-1fruokq"} data-styles-preset={"oeKkMxxkx"} style={{ "--framer-text-alignment": "center" }}>
                    Locations
                  </h4>
                </div>
              </div>
              <div className={"framer-18c9v5k"} data-framer-name={"Locations"}>
                <div className={"framer-opv9u6"} data-border={"true"} data-framer-name={"Warsaw Location Card"}>
                  <div className={"framer-p9anik-container"}>
                    <div borderradius={"0"} bottomleftradius={"0"} bottomrightradius={"0"} height={"100%"} id={"eN70OT2tp"} topleftradius={"0"} toprightradius={"0"} width={"100%"} style={{ height: "100%", width: "100%", position: "relative", display: "flex", justifyContent: "center", alignItems: "center", overflow: "hidden", borderRadius: "0px" }}>
                      <iframe style={{ height: "100%", width: "100%", border: "0" }} src={"https://maps.google.com/maps?q=52.24627797753017%2C%2021.022312420062196&z=15&output=embed"} />
                    </div>
                  </div>
                  <div className={"framer-h8xa2s"} style={{ transform: "none" }}>
                    <h5 className={"framer-text framer-styles-preset-1pa5d9r"} data-styles-preset={"kvcB0mldQ"}>
                      Warsaw, Poland
                    </h5>
                  </div>
                  <div className={"framer-jvgrme"} data-framer-name={"Address Wrapper"}>
                    <div className={"framer-ocwvq5-container"}>
                      <div style={{ display: "contents" }} />
                    </div>
                    <div className={"framer-wclfe"} style={{ transform: "none" }}>
                      <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-alignment": "left" }}>
                        Marszałkowska St, 00-033, Warsaw
                      </p>
                    </div>
                  </div>
                  <div className={"framer-u1z28c-container"}>
                    <a className={"framer-3qE1p framer-CvaDL framer-TMFp6 framer-1kbhlz5 framer-v-8xagx7 framer-1hf9a6b"} data-framer-name={"Link"} href={"https://maps.app.goo.gl/JGZes2HCu9eZbn2v9"} target={"_blank"} rel={"noopener"} style={{ "--border-bottom-width": "0px", "--border-color": "rgba(0, 0, 0, 0)", "--border-left-width": "0px", "--border-right-width": "0px", "--border-style": "solid", "--border-top-width": "0px", backgroundColor: "rgba(0, 0, 0, 0)", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderTopLeftRadius: "0px", borderTopRightRadius: "0px" }}>
                ...
                <div className={"framer-w14j9a"} data-border={"true"} data-framer-name={"Krakow Location Card"}>
                  <div className={"framer-ds8i6w-container"}>
                    <div borderradius={"0"} bottomleftradius={"0"} bottomrightradius={"0"} height={"100%"} id={"pMvuyElIa"} topleftradius={"0"} toprightradius={"0"} width={"100%"} style={{ height: "100%", width: "100%", position: "relative", display: "flex", justifyContent: "center", alignItems: "center", overflow: "hidden", borderRadius: "0px" }}>
                      <iframe style={{ height: "100%", width: "100%", border: "0" }} src={"https://maps.google.com/maps?q=50.06261592680659%2C%2019.938211198400474&z=15&output=embed"} />
                    </div>
                  </div>
                  <div className={"framer-svd93s"} style={{ transform: "none" }}>
                    <h5 className={"framer-text framer-styles-preset-1pa5d9r"} data-styles-preset={"kvcB0mldQ"}>
                      Krakow, Poland
                    </h5>
                  </div>
                  <div className={"framer-1psyg4u"} data-framer-name={"Address Wrapper"}>
                    <div className={"framer-335jk4-container"}>
                      <div style={{ display: "contents" }} />
                    </div>
                    <div className={"framer-h66ck8"} style={{ transform: "none" }}>
                      <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-alignment": "left" }}>
                        Wawel 4, 31-003 Kraków
                      </p>
                    </div>
                  </div>
                  <div className={"framer-9d5o1j-container"}>
                    <a className={"framer-3qE1p framer-CvaDL framer-TMFp6 framer-1kbhlz5 framer-v-8xagx7 framer-1hf9a6b"} data-framer-name={"Link"} href={"https://maps.app.goo.gl/JGZes2HCu9eZbn2v9"} target={"_blank"} rel={"noopener"} style={{ "--border-bottom-width": "0px", "--border-color": "rgba(0, 0, 0, 0)", "--border-left-width": "0px", "--border-right-width": "0px", "--border-style": "solid", "--border-top-width": "0px", backgroundColor: "rgba(0, 0, 0, 0)", borderBottomLeftRadius: "0px", borderBottomRightRadius: "0px", borderTopLeftRadius: "0px", borderTopRightRadius: "0px" }}>
                      <div className={"framer-oof4xq"} style={{ "--extracted-r6o4lv": "var(--variable-reference-uryPfyK63-rNlYn_Jv1)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-uryPfyK63-rNlYn_Jv1": "var(--token-b3069982-89a8-4b09-8494-b9ff6cfd0669, rgb(8, 22, 70))", transform: "none" }}>
                        <p className={"framer-text framer-styles-preset-ee3jw3"} data-styles-preset={"d2_XrBlDp"}>
                          Get Direction
          ...
          <div className={"framer-1v0mec3"} data-framer-name={"Form Section"}>
            <div className={"framer-jk3imv"} data-framer-name={"Contact Form"}>
              <div className={"framer-mr38at hidden-1n59o3y"} data-framer-name={"Union"}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                  <img decoding={"async"} width={"79"} height={"131"} src={"/assets/framerusercontent.com/images/rqKzz9PpDtlsth4yi8GrW2eaBc_q49817a66.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                </div>
              </div>
              <div className={"framer-1bahalk"} data-framer-name={"Star "}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                  <img decoding={"async"} width={"75"} height={"75"} src={"/assets/framerusercontent.com/images/fy7nkCD9bdBRf83DFU0xRVtWZFk_q80f96b68.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                </div>
              </div>
              <div className={"framer-62ji7n"} data-framer-name={"Title"}>
                <div data-framer-name={"Star"} className={"framer-kpvh8y"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
                  <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                    <svg style={{ width: "100%", height: "100%" }} viewBox={"0 0 25 25"}>
                      <use href={"#svg76722627_457"} />
                    </svg>
                ...
                <div className={"framer-zewi4o"} style={{ transform: "none" }}>
                  <h4 className={"framer-text framer-styles-preset-10ofw0b"} data-styles-preset={"Ks8ax5XhD"} style={{ "--framer-text-alignment": "center" }}>
                    Contact
                  </h4>
                </div>
                <div className={"framer-1oewsb4"} style={{ transform: "none" }}>
                  <h4 className={"framer-text framer-styles-preset-1fruokq"} data-styles-preset={"oeKkMxxkx"} style={{ "--framer-text-alignment": "center" }}>
                    Our Team
                  </h4>
                </div>
              </div>
              <div className={"framer-7388sk"} data-framer-name={"Form Wrapper"}>
                <form className={"framer-1ahr38i"}>
                  <label className={"framer-c46uum"}>
                    <div className={"framer-1xhbrcs"} style={{ transform: "none" }}>
                      <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                        Contact Person
                      </p>
                    </div>
                    <div className={"framer-form-text-input framer-form-input-wrapper framer-15lla3x framer-form-text-input-type"}>
                      <input type={"text"} name={"Name"} placeholder={"Jane Smith"} className={"framer-form-input framer-form-input-empty"} value={null} />
                    </div>
                  </label>
                  <div className={"framer-jb7cd9"} data-framer-name={"Email & Phone"}>
                    <label className={"framer-b3i39w"}>
                      <div className={"framer-1t6bv9a"} style={{ transform: "none" }}>
                        <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                          Email Address
                        </p>
                      </div>
                      <div className={"framer-form-text-input framer-form-input-wrapper framer-rpy7ff"}>
                        <input type={"email"} name={"Email"} placeholder={"Email Address"} className={"framer-form-input framer-form-input-empty"} value={null} />
                      </div>
                    </label>
                    <label className={"framer-178p6gz"}>
                      <div className={"framer-4gmv1q"} style={{ transform: "none" }}>
                        <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                          Phone
                        </p>
                      </div>
                      <div className={"framer-form-text-input framer-form-input-wrapper framer-vppy60"}>
                        <input type={"tel"} name={"Phone Number"} placeholder={"Phone Number"} className={"framer-form-input framer-form-input-empty"} value={null} />
                      </div>
                    </label>
                  </div>
                  <div className={"ssr-variant"}>
                    <div className={"framer-3obt4q-container"}>
                      <button type={"submit"} className={"framer-cOt14 framer-12ozwzs framer-v-12ozwzs"} data-framer-name={"Default"} data-reset={"button"} tabIndex={"0"} style={{ backgroundColor: "var(--token-fbb687f5-36a6-434d-ba90-5015fee6487b, rgb(255, 100, 100))", height: "100%", width: "100%", borderBottomLeftRadius: "10px", borderBottomRightRadius: "10px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px", opacity: "1" }}>
                  ...
                  <input type={"text"} name={"website"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={null} />
                  <input type={"text"} name={"company"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={null} />
                  <input type={"text"} name={"message"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={null} />
                  <input type={"text"} name={"subject"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={null} />
                  <input type={"text"} name={"title"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={null} />
                  <input type={"text"} name={"description"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={null} />
                  <input type={"text"} name={"feedback"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={null} />
                  <input type={"text"} name={"notes"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={null} />
                  <input type={"text"} name={"details"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={null} />
                  <input type={"text"} name={"remarks"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={null} />
                  <input type={"text"} name={"comments"} tabIndex={"-1"} autoComplete={"one-time-code"} aria-hidden={"true"} style={{ position: "absolute", transform: "scale(0)" }} data-1p-ignore={"true"} data-lpignore={"true"} data-form-type={"other"} data-bwignore={"true"} value={null} />
                </form>
              </div>
            </div>
          </div>
          <div className={"framer-1nx63q0-container"}>
            <div className={"ssr-variant hidden-1n59o3y hidden-37gqd4 hidden-1789ns3"}>
                  ...
                  <div className={"framer-yzdyko"} data-framer-name={"Container"}>
                    <div className={"framer-ej2af3"} data-framer-name={"CTA"} style={{ backgroundColor: "var(--token-f787c18e-5195-4593-b2b5-95a95cb0c856, rgb(255, 207, 85))", borderBottomLeftRadius: "40px", borderBottomRightRadius: "40px", borderTopLeftRadius: "40px", borderTopRightRadius: "40px" }}>
                      <div className={"framer-dhpc42"} data-framer-name={"Content"}>
                        ...
                        <div className={"framer-eyayf8"} data-framer-name={"Kid-min"}>
                          <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }}>
                            <img decoding={"async"} width={"860"} height={"952"} sizes={"(min-width: 1440px) 438px, (max-width: 809.98px) 237px, (min-width: 1200px) and (max-width: 1439.98px) 438px, (min-width: 810px) and (max-width: 1199.98px) 304px"} srcSet={"/assets/framerusercontent.com/images/6iApQ13GmjM1UDnfuGx4RzFCQ_qe949f92d.png 860w"} src={"/assets/framerusercontent.com/images/6iApQ13GmjM1UDnfuGx4RzFCQ_qe949f92d.png"} alt={null} style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} />
                          </div>
                        </div>
                      </div>
                    ...
                    <div className={"framer-2u726k"} data-framer-name={"Footer Content"}>
                      <div className={"framer-uw0mir"} data-framer-name={"Content"}>
                        ...
                        <div className={"framer-1ddnjn9"} data-framer-name={"Menus"}>
                          <div className={"framer-19qe0r1"} data-framer-name={"Home"}>
                            ...
                            <div className={"framer-uptdag-container"}>
                              <div className={"framer-n3R26 framer-5BS8D framer-OdaN4 framer-19r24ke framer-v-19r24ke"} data-framer-name={"Variant 1"}>
                                <div className={"framer-fjvfw"} style={{ "--extracted-r6o4lv": "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", transform: "none" }}>
                                  <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255)))" }}>
                            ...
                            <div className={"framer-1qt0o9a-container"}>
                              <div className={"framer-n3R26 framer-5BS8D framer-OdaN4 framer-19r24ke framer-v-19r24ke"} data-framer-name={"Variant 1"}>
                                <div className={"framer-fjvfw"} style={{ "--extracted-r6o4lv": "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", transform: "none" }}>
                                  <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255)))" }}>
                            ...
                            <div className={"framer-1vb9z00-container"}>
                              <div className={"framer-n3R26 framer-5BS8D framer-OdaN4 framer-19r24ke framer-v-19r24ke"} data-framer-name={"Variant 1"}>
                                <div className={"framer-fjvfw"} style={{ "--extracted-r6o4lv": "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", transform: "none" }}>
                                  <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255)))" }}>
                            ...
                            <div className={"framer-1dsbygk-container"}>
                              <div className={"framer-n3R26 framer-5BS8D framer-OdaN4 framer-19r24ke framer-v-19r24ke"} data-framer-name={"Variant 1"}>
                                <div className={"framer-fjvfw"} style={{ "--extracted-r6o4lv": "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", transform: "none" }}>
                                  <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255)))" }}>
                          ...
                          <div className={"framer-3icnrk"} data-framer-name={"Resources"}>
                            <div className={"framer-bqukxa"} style={{ "--extracted-1w1cjl5": "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none" }}>
                              <h6 className={"framer-text framer-styles-preset-14lyf0"} data-styles-preset={"iqdj89sBP"} style={{ "--framer-text-color": "var(--extracted-1w1cjl5, var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255)))" }} />
                            </div>
                            <div className={"framer-1bp5pan-container"}>
                              <div className={"framer-n3R26 framer-5BS8D framer-OdaN4 framer-19r24ke framer-v-19r24ke"} data-framer-name={"Variant 1"}>
                                <div className={"framer-fjvfw"} style={{ "--extracted-r6o4lv": "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", transform: "none" }}>
                                  <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255)))" }}>
                            ...
                            <div className={"framer-1doqeyj-container"}>
                              <div className={"framer-n3R26 framer-5BS8D framer-OdaN4 framer-19r24ke framer-v-19r24ke"} data-framer-name={"Variant 1"}>
                                <div className={"framer-fjvfw"} style={{ "--extracted-r6o4lv": "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", transform: "none" }}>
                                  <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255)))" }}>
                            ...
                            <div className={"framer-1swd72n-container"}>
                              <div className={"framer-n3R26 framer-5BS8D framer-OdaN4 framer-19r24ke framer-v-19r24ke"} data-framer-name={"Variant 1"}>
                                <div className={"framer-fjvfw"} style={{ "--extracted-r6o4lv": "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", transform: "none" }}>
                                  <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255)))" }}>
                            ...
                            <div className={"framer-g4kkb1-container"}>
                              <div className={"framer-n3R26 framer-5BS8D framer-OdaN4 framer-19r24ke framer-v-19r24ke"} data-framer-name={"Variant 1"}>
                                <div className={"framer-fjvfw"} style={{ "--extracted-r6o4lv": "var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255))", transform: "none" }}>
                                  <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"} style={{ "--framer-text-color": "var(--extracted-r6o4lv, var(--token-ce18055f-bbbe-4a53-a731-e618b46c3b0e, rgb(255, 255, 255)))" }}>
            ...
            <div className={"ssr-variant hidden-1n59o3y hidden-of2izi hidden-37gqd4"}>
