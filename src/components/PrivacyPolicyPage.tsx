...
// Styles exacts : importer "framer-privacy-policy.css" une seule fois (layout global).
import './framer-privacy-policy.css';

export default function PrivacyPolicyPage() {
  return (
    <>
      <div id={"main"}>
        <div className={"framer-Qz5uY framer-47Dft framer-5BS8D framer-11w7lem"} style={{ minHeight: "100vh", width: "auto" }}>
          <div className={"framer-17vt1y7"} data-framer-name={"Header"} name={"Header"}>
            <div className={"framer-ajnu7r"} style={{ transform: "none" }}>
              <h2 className={"framer-text framer-styles-preset-h971pb"} data-styles-preset={"CEhR1NBj_"} style={{ "--framer-text-alignment": "center" }}>
                Confidentialité
              </h2>
            </div>
            <div data-framer-name={"red star"} name={"red star"} className={"framer-337f3f"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
            ...
            <div data-framer-name={"Star "} name={"Star "} className={"framer-189ctxq"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Blue "} name={"Blue "} className={"framer-bbcisx"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div data-framer-name={"Green"} name={"Green"} className={"framer-ye22w7"} aria-hidden={"true"} style={{ imageRendering: "pixelated", flexShrink: "0", fill: "black", color: "black" }}>
              <div className={"svgContainer"} style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
          ...
          <div className={"framer-ui903z"} data-framer-name={"Privacy Policy"} name={"Privacy Policy"}>
            <div className={"framer-1n1jo5a"} data-framer-name={"Text Wrapper"} name={"Text Wrapper"}>
              <div className={"framer-1ohmoru"} style={{ transform: "none" }}>
                <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  <strong className={"framer-text"}>
                    Kid Sport Club
                  </strong>
                  ("we," "us," or "our") is committed to protecting the privacy and security of our students, parents, staff, and visitors. This privacy policy outlines how we collect, use, store, and protect personal information, in compliance with applicable privacy laws and regulations.
                </p>
                <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  <strong className={"framer-text"}>
                ...
                <ul className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  <li className={"framer-text"}>
                    <p className={"framer-text"}>
                      <strong className={"framer-text"}>
                        Students:
                      </strong>
                      Full name, date of birth, home address, medical information, emergency contact details, academic records, and behavioral reports.
                    </p>
                  </li>
                  <li className={"framer-text"}>
                    <p className={"framer-text"}>
                ...
                <ul className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  ...
                  <li className={"framer-text"}>
                    <p className={"framer-text"}>
                      ...
                      To inform parents/guardians about their child's progress, school events, and important updates.
                    </p>
                  </li>
                  <li className={"framer-text"}>
                    <p className={"framer-text"}>
                      ...
                      To ensure the health, safety, and well-being of students and staff.
                    </p>
                  </li>
                  <li className={"framer-text"}>
                    <p className={"framer-text"}>
                      ...
                      To comply with local, state, or federal regulations, and to respond to any legal claims or processes.
                    </p>
                  </li>
                </ul>
                <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                ...
                <ul className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  <li className={"framer-text"}>
                    <p className={"framer-text"}>
                      ...
                      We may share data with trusted third-party service providers who assist us in providing educational tools, platforms, or administrative services (e.g., online learning platforms, cloud services, etc.). These providers are bound by confidentiality agreements and are only permitted to use the data as required to fulfill their services.
                    </p>
                  </li>
                  <li className={"framer-text"}>
                    <p className={"framer-text"}>
                ...
                <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  However, please note that no method of transmission over the internet or method of electronic storage is completely secure. While we strive to protect your personal information, we cannot guarantee absolute security.
                </p>
                <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  <strong className={"framer-text"}>
                    5. Data Retention
                ...
                <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  We retain personal information for as long as necessary to fulfill the purposes outlined in this policy, unless a longer retention period is required or permitted by law. When information is no longer needed, we will securely delete or anonymize it.
                </p>
                <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  <strong className={"framer-text"}>
                    6. Parental Consent and Children’s Privacy
                  </strong>
                </p>
                <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                ...
                <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  Parents/guardians have the right to review, amend, or request the deletion of their child’s personal information at any time by contacting us at [email address].
                </p>
                <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  <strong className={"framer-text"}>
                ...
                <ul className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  <li className={"framer-text"}>
                    <p className={"framer-text"}>
                      ...
                      You can request access to the personal information we hold about you or your child.
                    </p>
                  </li>
                  <li className={"framer-text"}>
                    <p className={"framer-text"}>
                ...
                <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  Our website may use cookies and similar tracking technologies to improve user experience and analyze site usage. Cookies are small data files stored on your device. You can choose to block or delete cookies via your browser settings, though this may affect the functionality of our website.
                </p>
                <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  <strong className={"framer-text"}>
                ...
                <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  We may update this privacy policy from time to time to reflect changes in our practices, legal requirements, or operational needs. We will notify you of any material changes by posting an updated version on our website and revising the "Last Updated" date.
                </p>
                <p className={"framer-text framer-styles-preset-1k2s06t"} data-styles-preset={"uXoMYZPg0"}>
                  <strong className={"framer-text"}>
                    10. Contact Us
          ...
          <div className={"ssr-variant hidden-1eodm3t hidden-p9cck"}>
            <div className={"framer-owvdav-container"}>
              <div className={"ssr-variant hidden-1ppti1b"}>
              ...
              <div className={"ssr-variant hidden-11w7lem"}>
          ...
          <div className={"ssr-variant hidden-1ppti1b hidden-p9cck hidden-11w7lem"}>
            <div className={"framer-owvdav-container"}>
          ...
          <div className={"ssr-variant hidden-1ppti1b hidden-1eodm3t hidden-11w7lem"}>
            <div className={"framer-owvdav-container"}>
          ...
          <div className={"framer-1bwb3ki-container"}>
            <div className={"ssr-variant hidden-1ppti1b hidden-1eodm3t hidden-p9cck"}>
            ...
            <div className={"ssr-variant hidden-1eodm3t hidden-p9cck hidden-11w7lem"}>
            ...
            <div className={"ssr-variant hidden-1ppti1b hidden-11w7lem"}>
        ...
        <div className={"framer-Qz5uY framer-47Dft framer-5BS8D"} id={"overlay"} />
      </div>
    </>
  );
}
