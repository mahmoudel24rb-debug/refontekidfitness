...
export const AVIS: AvisFichier[] = [
  ...
  {
    texte:
      'Kid Sport Club offre un choix varié d’activités pour les enfants (pom-pom girl, crossfit boxing, zumba, sports de combat, baby gym....), ce qui permet de travailler entre autres : la coordination, la souplesse, la rigueur, l’esprit d’équipe. Des cours parents/enfants sont proposés (fit family) afin de renforcer les liens et de se lancer des défis. La salle est ouverte du lundi au samedi, ce qui permet de s’adapter au planning de chacun. Les coachs sont bienveillants et s’adaptent à chaque public.',
